...
public class DrawingArea extends QueueNode {
	...
	public static void fillRectangle(int color, int y, int width, int height, int opacity, int x) {
		if (x < topX) {
			width -= topX - x;
			x = topX;
		}
		...
		int pixelWidthStep = DrawingArea.width - width;
		int startPixel = x + y * DrawingArea.width;
