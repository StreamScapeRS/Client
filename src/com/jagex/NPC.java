...
public final class NPC extends Entity {
	...
	private Model getAnimatedModel() {
		...
		if (super.anim >= 0 && super.animationDelay == 0) {
			...
			// int frame =
			// Animation.anims[super.anim].anIntArray353[super.anInt1527];
			int i1 = -1;
			if (super.anInt1517 >= 0 && super.anInt1517 != super.anInt1511)
				i1 = Animation.anims[super.anInt1517].frameIDs[super.currentForcedAnimFrame];
			return desc.method164(i1, currentFrame, Animation.anims[super.anim].animationFlowControl, nextFrame, cycle1,
					cycle2);
		}
