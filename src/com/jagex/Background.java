...
public final class Background extends DrawingArea {
	...
	public void plotScale(int pixels[], byte imgPixels[], int palette[], int i, int j, int k, int l, int stretchWidth,
			int stretchHeight, int k1, int l1, int width) {
		try {
			int j2 = i;
	...
	public void spriteClip(int x, int y, int stretchWidth, int stretchHeight) {
		try {
			...
			plotScale(DrawingArea.pixels, imgPixels, palette, k1, l1, i3, j3, stretchWidth, stretchHeight, i2, j2,
					width);
		} catch (Exception exception) {
