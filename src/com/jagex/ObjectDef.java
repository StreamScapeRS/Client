...
public final class ObjectDef {
	...
	public static ObjectDef forID(int i) {
		boolean loadNew = i == 32159 || i == 32157 || i == 36672 || i == 36675 || i == 36692 || i == 34138
				|| i >= 39260 && i <= 39271 || i == 39229 || i == 39230 || i == 39231 || i == 36676 || i == 36692
				|| i > 11915 && i <= 11929 || i >= 11426 && i <= 11444 || i >= 14835 && i <= 14845
				|| i >= 11391 && i <= 11397 || i >= 12713 && i <= 12715;
		for (int j = 0; j < 20; j++) {
			if (cache[j].type == i) {
				return cache[j];
			}
		...
		if (i == 172) {
			objectDef.name = "Mystery Key Chest";
		}
		if (i == 26193) {
		...
		if(i == 12000) {
			objectDef.name = "Snow Event";
			objectDef.objectModelIDs = new int[] {30306};
			objectDef.actions = new String[] { "Enter", null, null, null, null };

		}
		if(i == 12001) {
			objectDef.name = "Xmas tree";
			objectDef.objectModelIDs = new int[] {62446};
			objectDef.actions = new String[] { null, null, null, null, null };

		}
		if(i == 12002) {
			objectDef.name = "Presents";
			objectDef.objectModelIDs = new int[] {51180};
			objectDef.actions = new String[] { null, null, null, null, null };

		}
		if(i == 12003) {
			objectDef.name = "@red@Present";
			objectDef.objectModelIDs = new int[] {51180};
			objectDef.actions = new String[] { "Search", null, null, null, null };

		}
		if(i == 12004) {
			objectDef.name = "@mag@Present";
			objectDef.objectModelIDs = new int[] {51180};
			objectDef.actions = new String[] { "Search", null, null, null, null };
		...
		case 4874:
			...
			break;
		case 817:
			objectDef.name = "Morune Stall";
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Steal from";
			objectDef.objectModelIDs = new int[] { 65217 };
			objectDef.originalModelColors = new int[] { 928 };
			objectDef.modifiedModelColors = new int[] { 661 };
			break;
		case 7100:
			objectDef.name = "Blue Dragon Stall";
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Steal from";
			objectDef.objectModelIDs = new int[] { 65218 };
			break;
		case 2152:
			objectDef.actions = new String[5];
	...
	private Model getAnimatedModel(int objectType, int animId, int face) {
		...
		if (objectModelTypes == null) {
			...
			hash = (type << 8) + face + ((long) (animId + 1) << 32);
			...
			hash = (type << 8) + (i1 << 3) + face + ((long) (animId + 1) << 32);
