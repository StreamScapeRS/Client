...
public final class Animation {
	...
	public static void unpackConfig(CacheArchive streamLoader) {
		...
		for (int j = 0; j < length; j++) {
			 ...
			 * 244252743, 244252685}; } if(j == 10901) { anims[j].frameCount = 19;
			 * anims[j].loopDelay = 19; anims[j].delays = new int[]{3, 3, 3, 3, 3, 3, 3, 3,
			 * 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3}; anims[j].frameIDs = new int[]{244252826,
			 * 244252833, 244252674, 244252724, 244252793, 244252696, 244252787, 244252753,
			 * 244252703, 244252800, 244252752, 244252744, 244252680, 244252815, 244252829,
			 * 244252769, 244252699, 244252757, 244252695}; }
			 */
		}
	}
