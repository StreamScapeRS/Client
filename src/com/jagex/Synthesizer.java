	...
	public int[] synthesize(int sampleLength, int j) {
		...
		for (int j2 = 0; j2 < 5; j2++)
			if (anIntArray106[j2] != 0) {
				...
				anIntArray121[j2] = (int) (((samp1.anInt539 - samp1.anInt538) * 32.768000000000001D
						* Math.pow(1.0057929410678534D, cents[j2])) / rate);
				...
				for (; j7 < l7; j7++) {
					...
					for (int k8 = 0; k8 < i5; k8++)
						j8 += (int) ((long) samples[(j7 + i5) - 1 - k8]
								* (long) Filter.anIntArrayArray670[0][k8] >> 16);
					...
					for (; j7 < l7; j7++) {
						...
						for (int k9 = 0; k9 < i5; k9++)
							l8 += (int) ((long) samples[(j7 + i5) - 1 - k9]
									* (long) Filter.anIntArrayArray670[0][k9] >> 16);
				...
				for (; j7 < sampleLength; j7++) {
					...
					for (int l9 = (j7 + i5) - sampleLength; l9 < i5; l9++)
						i9 += (int) ((long) samples[(j7 + i5) - 1 - l9]
								* (long) Filter.anIntArrayArray670[0][l9] >> 16);
