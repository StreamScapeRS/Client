...
final class ObjectManager {
						...
						if (k17 >= 1 && k17 < anInt147 - 1 && (!(lowMem) || (tileSettings[0][l6][k17] & 2) != 0
							...
							if (l18 > 0 || i19 > 0) {
								...
								if (l > 0) {
									...
									try {
										if (i19 > 0 && OverlayFloor.overlayFloor[i19 - 1] != null
								...
								if (i19 == 0) {
									worldController.addTile(l, l6, k17, 0, 0, -1, 154, j19, k19, l19, i20,
									...
									/*
									 * Fixes some floors that are black
									 */
									if (i19 - 1 >= OverlayFloor.overlayFloor.length) {
										continue;
									}
									OverlayFloor flo_2 = OverlayFloor.overlayFloor[i19 - 1];
									...
									worldController.addTile(l, l6, k17, k22, byte4, floorTexture, 154, j19, k19, l19,
	...
	public void method175(int y, WorldController worldController, CollisionDetection class11, int j, int z, int x,
		...
		try {
			...
			/***
			 * removing anykind of walls without blackscreen and decore
			 */

			int mX = GameClient.instance.currentRegionX - 6;
			int mY = GameClient.instance.currentRegionY - 6;
			int actualX = mX * 8 + x;
			int actualY = mY * 8 + y;
			int actualH = z;

			// yewtree
			if (actualX < 3088 || actualY < 3470 || actualX > 3096 || actualY > 3483) {

				if (actualH >= 0 && (actualX >= 3080 && actualX <= 3098) && (actualY >= 3464 && actualY <= 3483)) {
					boolean dontRemove = i1 == 26933; // object ids of custom objects at edgeville walls
					if (!dontRemove) {
						return;
					}
				}
				...
				if (j == 10 || j == 11) {
					...
					if (obj1 != null) {
						...
						if (worldController.addInteractableEntity(l2, byte0, k2, l4, ((Animable) (obj1)), j4, z, i5, y,
								x, i1) && objectDef.aBoolean779) {
							Model model;
				...
				if (j == 0) {
					...
					worldController.addWallObject(anIntArray152[j1], ((Animable) (obj3)), l2, y, byte0, x, null, k2, 0,
							z, i1);
					if (j1 == 0) {
				...
				if (j == 1) {
					...
					worldController.addWallObject(anIntArray140[j1], ((Animable) (obj4)), l2, y, byte0, x, null, k2, 0,
							z, i1);
					if (objectDef.aBoolean779)
						if (j1 == 0)
							aByteArrayArrayArray134[z][x][y + 1] = 50;
				...
				if (j == 3) {
					...
					worldController.addWallObject(anIntArray140[j1], ((Animable) (obj5)), l2, y, byte0, x, null, k2, 0,
							z, i1);
					if (objectDef.aBoolean779)
						if (j1 == 0)
							aByteArrayArrayArray134[z][x][y + 1] = 50;
				...
				if (j == 5) {
					...
					worldController.addWallDecoration(l2, y, j1 * 512, z, anIntArray137[j1] * i4, k2,
							((Animable) (obj13)), x, byte0, anIntArray144[j1] * i4, anIntArray152[j1], i1);
					return;
				}
				if (j == 6) {
					Object obj8;
	...
	public final void readObjectMap(CollisionDetection clippingPlanes[], WorldController worldController, int myPlane,
			...
			int baseYTile) {
		label0: {
			Stream stream = new Stream(mapData); // turns the .dat file into a
													// stream.
			int foundObjectId = -1;
			do {
				...
				do {
					...
					int k3 = stream.readUnsignedByte(); // reads orienetation j
														// & j1
					int type = k3 >> 2;
			...
			do {
				...
				do {
					...
					if (j3 > 0 && k3 > 0 && j3 < 103 && k3 < 103) {
						...
						if (l3 >= 0 && l3 < 4)
							class11 = aclass11[l3];
						// hardcoding unwalkable tiles to be walkable by not
						// drawing thtem
						int xPos = (j3 + GameClient.getBaseX());
						int yPos = (k3 + GameClient.getBaseY());
						boolean draw = true;
						if (2889 == xPos && 9831 == yPos || 9830 == yPos) {
							draw = false;
						}
						if (draw)
