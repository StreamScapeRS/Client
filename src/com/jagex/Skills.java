...
public final class Skills {
	...
	public static String[] SKILL_NAMES = { "Attack", "Constitution", "Mining", "Strength", "Agility", "Smithing",
	...
	public static final boolean[] SKILLS_ENABLED = { true, true, true, true, true, true, true, true, true, true, true,
	...
	public static int SKILL_ID(int ids) {
		int[] hoverIds = { 4040, 4076, 4112, 4046, 4082, 4118, 4052, 4088, 4124, 4058, 4094, 4130, 4064, 4100, 4136,
	...
	public static int SKILL_ID_NAME(String name) {
		...
		int[] skillID = { 0, 3, 14, 2, 16, 13, 1, 15, 10, 4, 17, 7, 5, 12, 11, 6, 9, 8, 20, 18, 19, 21, 22, 23, 24,
				25 };
		String[] names = { "Attack", "Constitution", "Mining", "Strength", "Agility", "Smithing", "Defence", "Herblore",
				"Fishing", "Ranged", "Thieving", "Cooking", "Prayer", "Crafting", "Firemaking", "Magic", "Fletching",
				"Woodcutting", "Runecrafting", "Slayer", "Farming", "Construction", "Hunter", "Summoning",
				"Dungeoneering" };
