...
public class Model extends Animable {
	...
	private void readOldModel(int i) {
		...
		if (header.facePriorityBasePos >= 0)
			facePriorities = new int[numberOfTriangleFaces];
		else
				...
				for (int j1 = 0; j1 < model_1.numberOfTriangleFaces; j1++) {
					...
					if (flag1)
						if (model_1.facePriorities == null)
							facePriorities[numberOfTriangleFaces] = model_1.face_priority;
						else
							facePriorities[numberOfTriangleFaces] = model_1.facePriorities[j1];
					if (flag2)
				...
				for (int i2 = 0; i2 < model_1.numberOfTriangleFaces; i2++) {
					...
					if (flag2)
						if (model_1.facePriorities == null)
							...
							facePriorities[numberOfTriangleFaces] = model_1.facePriorities[i2];
					if (flag3)
						if (model_1.face_alpha == null)
							face_alpha[numberOfTriangleFaces] = 0;
						else
	...
	public void method464(Model model, boolean flag) {
		...
		if (anIntArray1622.length < numberOfVerticeCoordinates) {
			anIntArray1622 = new int[numberOfVerticeCoordinates + 100000];
			anIntArray1623 = new int[numberOfVerticeCoordinates + 100000];
			anIntArray1624 = new int[numberOfVerticeCoordinates + 100000];
		}
	...
	public void recolour(int itemId, int editedColor, int originalColor) {
		for (int k = 0; k < face_color.length; k++) {
	...
	static boolean hasAnEdgeToRestrict[] = new boolean[9000];
	static boolean outOfReach[] = new boolean[9000];
	static int projected_vertex_x[] = new int[9000];
	static int projected_vertex_y[] = new int[9000];
	static int projected_vertex_z[] = new int[9000];
	static int anIntArray1667[] = new int[9000];
	static int camera_vertex_y[] = new int[9000];
	static int camera_vertex_x[] = new int[9000];
	static int camera_vertex_z[] = new int[9000];
