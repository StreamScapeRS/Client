...
public class DrawingArea474 extends DrawingArea {
	...
	public static void drawAlphaUnfilledPixels(int x, int y, int width, int height, int color, int alpha) {// method588
	...
	public static void drawUnfilledPixels(int x, int y, int width, int height, int color) {// method595
