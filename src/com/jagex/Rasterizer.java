...
public final class Rasterizer extends DrawingArea {
	...
	public static int fogColor = 0x999999;
	...
	public static void drawMaterializedTriangle(int y1, int y2, int y3, int x1, int x2, int x3, int hsl1, int hsl2,
			int hsl3, int tx1, int tx2, int tx3, int ty1, int ty2, int ty3, int tz1, int tz2, int tz3, int tex, int z1,
			int z2, int z3) {
		if (!GameClient.getOption("hd_tex") || ProceduralTexture.get(tex) == null) {
			drawGouraudTriangle(y1, y2, y3, x1, x2, x3, hsl1, hsl2, hsl3, z1, z2, z3);
			return;
		}
		setMipmapLevel(y1, y2, y3, x1, x2, x3, tex);
		int[] texels = TextureCache.getTexturePixels(tex);
		tx2 = tx1 - tx2;
		ty2 = ty1 - ty2;
		tz2 = tz1 - tz2;
		tx3 -= tx1;
	...
	private static final void drawMaterializedScanline(int[] dest, int[] texels, int offset, int x1, int x2, int hsl1,
			int hsl2, int t1, int t2, int t3, int t4, int t5, int t6, int z1, int z2) {
		if (x2 <= x1) {
			return;
		}
		int texPos = 0;
	...
	public static void drawTexturedTriangle317(int y1, int y2, int y3, int x1, int x2, int x3, int c1, int c2, int c3,
			int t1, int t2, int t3, int t4, int t5, int t6, int t7, int t8, int t9, int tex) {
		c1 = 0x7f - c1;
		c2 = 0x7f - c2;
		c3 = 0x7f - c3;
		setMipmapLevel(y1, y2, y3, x1, x2, x3, tex);
		...
		if (y1 <= y2 && y1 <= y3) {
			...
			if (y2 < y3) {
				...
				if (y1 != y2 && i8 < i7 || y1 == y2 && i8 > k7) {
					...
					y1 = anIntArray1472[y1];
					while (--y2 >= 0) {
						drawTexturedScanline317(pixels, texels, y1, x3 >> 16, x1 >> 16, c3 >> 8, c1 >> 8, l4, k5, j6,
								i5, l5, k6);
						x3 += i8;
						x1 += i7;
						c3 += j8;
					...
					while (--y3 >= 0) {
						drawTexturedScanline317(pixels, texels, y1, x3 >> 16, x2 >> 16, c3 >> 8, c2 >> 8, l4, k5, j6,
								i5, l5, k6);
						x3 += i8;
						x2 += k7;
						c3 += j8;
				...
				y1 = anIntArray1472[y1];
				while (--y2 >= 0) {
					drawTexturedScanline317(pixels, texels, y1, x1 >> 16, x3 >> 16, c1 >> 8, c3 >> 8, l4, k5, j6, i5,
							l5, k6);
					x3 += i8;
					x1 += i7;
					c3 += j8;
				...
				while (--y3 >= 0) {
					drawTexturedScanline317(pixels, texels, y1, x2 >> 16, x3 >> 16, c2 >> 8, c3 >> 8, l4, k5, j6, i5,
							l5, k6);
					x3 += i8;
					x2 += k7;
					c3 += j8;
			...
			if (y1 != y3 && i8 < i7 || y1 == y3 && k7 > i7) {
				...
				y1 = anIntArray1472[y1];
				while (--y3 >= 0) {
					drawTexturedScanline317(pixels, texels, y1, x2 >> 16, x1 >> 16, c2 >> 8, c1 >> 8, l4, k5, j6, i5,
							l5, k6);
					x2 += i8;
					x1 += i7;
					c2 += j8;
				...
				while (--y2 >= 0) {
					drawTexturedScanline317(pixels, texels, y1, x3 >> 16, x1 >> 16, c3 >> 8, c1 >> 8, l4, k5, j6, i5,
							l5, k6);
					x3 += k7;
					x1 += i7;
					c3 += l7;
			...
			y1 = anIntArray1472[y1];
			while (--y3 >= 0) {
				drawTexturedScanline317(pixels, texels, y1, x1 >> 16, x2 >> 16, c1 >> 8, c2 >> 8, l4, k5, j6, i5, l5,
						k6);
				x2 += i8;
				x1 += i7;
				c2 += j8;
			...
			while (--y2 >= 0) {
				drawTexturedScanline317(pixels, texels, y1, x1 >> 16, x3 >> 16, c1 >> 8, c3 >> 8, l4, k5, j6, i5, l5,
						k6);
				x3 += k7;
				x1 += i7;
				c3 += l7;
		...
		if (y2 <= y3) {
			...
			if (y3 < y1) {
				...
				if (y2 != y3 && i7 < k7 || y2 == y3 && i7 > i8) {
					...
					y2 = anIntArray1472[y2];
					while (--y3 >= 0) {
						drawTexturedScanline317(pixels, texels, y2, x1 >> 16, x2 >> 16, c1 >> 8, c2 >> 8, l4, k5, j6,
								i5, l5, k6);
						x1 += i7;
						x2 += k7;
						c1 += j7;
					...
					while (--y1 >= 0) {
						drawTexturedScanline317(pixels, texels, y2, x1 >> 16, x3 >> 16, c1 >> 8, c3 >> 8, l4, k5, j6,
								i5, l5, k6);
						x1 += i7;
						x3 += i8;
						c1 += j7;
				...
				y2 = anIntArray1472[y2];
				while (--y3 >= 0) {
					drawTexturedScanline317(pixels, texels, y2, x2 >> 16, x1 >> 16, c2 >> 8, c1 >> 8, l4, k5, j6, i5,
							l5, k6);
					x1 += i7;
					x2 += k7;
					c1 += j7;
				...
				while (--y1 >= 0) {
					drawTexturedScanline317(pixels, texels, y2, x3 >> 16, x1 >> 16, c3 >> 8, c1 >> 8, l4, k5, j6, i5,
							l5, k6);
					x1 += i7;
					x3 += i8;
					c1 += j7;
			...
			if (i7 < k7) {
				...
				y2 = anIntArray1472[y2];
				while (--y1 >= 0) {
					drawTexturedScanline317(pixels, texels, y2, x3 >> 16, x2 >> 16, c3 >> 8, c2 >> 8, l4, k5, j6, i5,
							l5, k6);
					x3 += i7;
					x2 += k7;
					c3 += j7;
				...
				while (--y3 >= 0) {
					drawTexturedScanline317(pixels, texels, y2, x1 >> 16, x2 >> 16, c1 >> 8, c2 >> 8, l4, k5, j6, i5,
							l5, k6);
					x1 += i8;
					x2 += k7;
					c1 += j8;
			...
			y2 = anIntArray1472[y2];
			while (--y1 >= 0) {
				drawTexturedScanline317(pixels, texels, y2, x2 >> 16, x3 >> 16, c2 >> 8, c3 >> 8, l4, k5, j6, i5, l5,
						k6);
				x3 += i7;
				x2 += k7;
				c3 += j7;
			...
			while (--y3 >= 0) {
				drawTexturedScanline317(pixels, texels, y2, x2 >> 16, x1 >> 16, c2 >> 8, c1 >> 8, l4, k5, j6, i5, l5,
						k6);
				x1 += i8;
				x2 += k7;
				c1 += j8;
		...
		if (y1 < y2) {
			...
			if (k7 < i8) {
				...
				y3 = anIntArray1472[y3];
				while (--y1 >= 0) {
					drawTexturedScanline317(pixels, texels, y3, x2 >> 16, x3 >> 16, c2 >> 8, c3 >> 8, l4, k5, j6, i5,
							l5, k6);
					x2 += k7;
					x3 += i8;
					c2 += l7;
				...
				while (--y2 >= 0) {
					drawTexturedScanline317(pixels, texels, y3, x2 >> 16, x1 >> 16, c2 >> 8, c1 >> 8, l4, k5, j6, i5,
							l5, k6);
					x2 += k7;
					x1 += i7;
					c2 += l7;
			...
			y3 = anIntArray1472[y3];
			while (--y1 >= 0) {
				drawTexturedScanline317(pixels, texels, y3, x3 >> 16, x2 >> 16, c3 >> 8, c2 >> 8, l4, k5, j6, i5, l5,
						k6);
				x2 += k7;
				x3 += i8;
				c2 += l7;
			...
			while (--y2 >= 0) {
				drawTexturedScanline317(pixels, texels, y3, x1 >> 16, x2 >> 16, c1 >> 8, c2 >> 8, l4, k5, j6, i5, l5,
						k6);
				x2 += k7;
				x1 += i7;
				c2 += l7;
		...
		if (k7 < i8) {
			...
			y3 = anIntArray1472[y3];
			while (--y2 >= 0) {
				drawTexturedScanline317(pixels, texels, y3, x1 >> 16, x3 >> 16, c1 >> 8, c3 >> 8, l4, k5, j6, i5, l5,
						k6);
				x1 += k7;
				x3 += i8;
				c1 += l7;
			...
			while (--y1 >= 0) {
				drawTexturedScanline317(pixels, texels, y3, x2 >> 16, x3 >> 16, c2 >> 8, c3 >> 8, l4, k5, j6, i5, l5,
						k6);
				x2 += i7;
				x3 += i8;
				c2 += j7;
	...
	private static void drawTexturedScanline317(int dest[], int src[], int offset, int x1, int x2, int lig1, int lig2,
	...
	public static void drawTexturedTriangle(int y1, int y2, int y3, int x1, int x2, int x3, int c1, int c2, int c3,
		...
		int i5 = (int) (((long) (ty3 * tz1 - tz3 * ty1) << 3 << 14) / WorldController.focalLength);
		int j5 = (int) (((long) (tz3 * tx1 - tx3 * tz1) << 14) / WorldController.focalLength);
		int k5 = tx2 * ty1 - ty2 * tx1 << 14;
		int l5 = (int) (((long) (ty2 * tz1 - tz2 * ty1) << 3 << 14) / WorldController.focalLength);
		int i6 = (int) (((long) (tz2 * tx1 - tx2 * tz1) << 14) / WorldController.focalLength);
		int j6 = ty2 * tx3 - tx2 * ty3 << 14;
		int k6 = (int) (((long) (tz2 * ty3 - ty2 * tz3) << 3 << 14) / WorldController.focalLength);
		int l6 = (int) (((long) (tx2 * tz3 - tz2 * tx3) << 14) / WorldController.focalLength);
		int i7 = 0;
		int j7 = 0;
		if (y2 != y1) {
			i7 = (x2 - x1 << 16) / (y2 - y1);
