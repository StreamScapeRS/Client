...
public class RSInterface {
	...
	public static void addSlider(int interfaceId, double min, double max, int iconSprite, int backgroundSprite,
								 int contentType) {
		RSInterface widget = interfaceCache[interfaceId] = new RSInterface();
		Sprite icon = SpriteLoader.sprites[iconSprite];
		Sprite background = SpriteLoader.sprites[backgroundSprite];
	...
	public static void addMediaModel(int id, int mediaID, int width, int height) {
	...
	public static void customization(TextDrawingArea[] tda) {
		...
		addSpriteLoader(60001, 1138);
		addMaxCape(60003, 75, 50, 420);

		int frame = 0;

		tab.totalChildren(28);
		tab.child(frame, 60001, 7, 15);
		frame++;
		tab.child(frame, 60003, 388, 252);
		frame++;
		int id = 60013;

		addConfigButtonWSpriteLoader(id, 60000, 1094, 1124, 25, 25, "Select Details Top", 1, 5, 1106, id + 100);
		setBounds(id, 195, 103, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 100, 1124, 25, 25, id + 101);
		setBounds(id + 100, 195, 103, frame, tab);
		frame++;
		id++;

		addConfigButtonWSpriteLoader(id, 60000, 1094, 1124, 25, 25, "Select Background (Top)", 2, 5, 1106, id + 200);
		setBounds(id, 195, 143, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 200, 1124, 25, 25, id + 201);
		setBounds(id + 200, 195, 143, frame, tab);
		frame++;
		id++;

		addConfigButtonWSpriteLoader(id, 60000, 1094, 1124, 25, 25, "Select Detail Bottom", 3, 5, 1106, id + 300);
		setBounds(id, 195, 183, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 300, 1124, 25, 25, id + 301);
		setBounds(id + 300, 195, 183, frame, tab);
		frame++;
		id++;

		addConfigButtonWSpriteLoader(id, 60000, 1094, 1124, 25, 25, "Select Background (Bottom)", 4, 5, 1106, id + 410);
		setBounds(id, 195, 223, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 410, 1124, 25, 25, id + 411);
		setBounds(id + 410, 195, 223, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1139, 122, 32, "Done", -1, id + 500, 5);
		setBounds(id, 195, 283, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 500, 1140, 122, 32, id + 501);
		setBounds(id + 500, 195, 283, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1125, 92, 22, "Save Preset", -1, id + 600, 5);
		setBounds(id, 380, 265, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 600, 1126, 92, 22, id + 601);
		setBounds(id + 600, 380, 265, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1127, 13, 11, "Remove Preset 1", -1, id + 700, 5);
		setBounds(id, 392, 304, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 700, 1130, 13, 11, id + 701);
		setBounds(id + 700, 392, 304, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1128, 13, 11, "Use Preset 1", -1, id + 800, 5);
		setBounds(id, 392, 293, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 800, 1129, 13, 11, id + 801);
		setBounds(id + 800, 392, 293, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1127, 13, 11, "Remove Preset 2", -1, id + 700, 5);
		setBounds(id, 430, 304, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 700, 1130, 13, 11, id + 701);
		setBounds(id + 700, 430, 304, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1128, 13, 11, "Use Preset 2", -1, id + 800, 5);
		setBounds(id, 430, 293, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 800, 1129, 13, 11, id + 801);
		setBounds(id + 800, 430, 293, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1127, 13, 11, "Remove Preset 3", -1, id + 700, 5);
		setBounds(id, 468, 304, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 700, 1130, 13, 11, id + 701);
		setBounds(id + 700, 468, 304, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1128, 13, 11, "Use Preset 3", -1, id + 800, 5);
		setBounds(id, 468, 293, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 800, 1129, 13, 11, id + 801);
		setBounds(id + 800, 468, 293, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1058, 18, 18, "Close", -1, id + 90, 3);
		setBounds(id, 195 + 285, 24, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 90, 1059, 18, 18, id + 91);
		setBounds(id + 90, 195 + 285, 24, frame, tab);
		frame++;
		id++;
	}

	public static void questJournalTab() {
		int id = 61994;

		RSInterface tab = addTabInterface(id);
		id++;
		int frame = 0;
		addHDSpriteLoader(id, 1231);
		...
		addHoverButtonWSpriteLoader(id, 1058, 18, 18, "Close", -1, id + 90, 3);
		setBounds(id, 195 + 281, 21, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 90, 1059, 18, 18, id + 91);
		setBounds(id + 90, 195 + 281, 21, frame, tab);
		frame++;
		id++;

		RSInterface scroll = interfaceCache[8143];
		scroll.width = 336;
		scroll.height = 176;

		scroll.scrollMax = 2000;

		tab.child(frame, 8143, 80, 100);
		frame++;

		tab.child(frame, 637, 260, 19);
		frame++;
	...
	public static void playersOnline() {
		...
		id++;
		int frame = 0;
		addSpriteLoader(id, 1232);

		tab.totalChildren(39);

		tab.child(frame, id, 6, 8);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1058, 18, 18, "Close", -1, id + 90, 3);
		setBounds(id, 195 + 284, 17, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 90, 1059, 18, 18, id + 91);
		setBounds(id + 90, 195 + 284, 17, frame, tab);
		frame++;
		id++;
		...
		int change = 192 + 95 + 95 + 95;

		final String[] TEXT = { "Time Played", "Game Mode", "Claimed", "Total Level", "Combat Level", "Vote Points",
				"Slayer Points", "Dung Tokens", "PK Points", "Kill Streak", "Player Kills", "Wild Deaths", };

		for (int i = 0; i < 12; i++) {
			// addHoverButtonWSpriteLoader(id, 1233, 92, 32, "", -1, id + hover, 0);
			// setBounds(id, x, y, frame, tab);
			// frame++;
			// addHoveredImageWSpriteLoader(id + hover, 1234, 92, 32, id + hover + 1);
			// setBounds(id + hover, x, y, frame, tab);
			// frame++;
			id++;
			// hover += 50;

			addText(id, TEXT[i], fonts, 0, 0x868686, true, true);
			setBounds(id, x + 46, y + 5, frame, tab);
			frame++;
			id++;

			addText(id, id + "", fonts, 0, 0xD21C1C, true, true);
			setBounds(id, x + 46, y + 18, frame, tab);
			frame++;
			id++;
		...
		addHoverButtonWSpriteLoader(id, 1236, 202, 42, "", -1, id + hover, 0);
		setBounds(id, 232, 62, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1236, 202, 42, id + hover + 1);
		setBounds(id + hover, 232, 62, frame, tab);
		frame++;
		id++;
		hover += 50;

		addText(id, " ", fonts, 3, 0x989898, true, true);
		setBounds(id, 332, 68, frame, tab);
		frame++;
		id++;

		addText(id, " ", fonts, 0, 0xD21C1C, false, true);
		setBounds(id, 300, 87, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1237, 92, 32, "Add to friends", -1, id + hover, 5);
		setBounds(id, 192, 268, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1238, 92, 32, id + hover + 1);
		setBounds(id + hover, 192, 268, frame, tab);
		frame++;
		id++;
		hover += 50;
		...
		setBounds(57040, -156, 95, frame, tab);
		frame++;

		addText(id, id + " ", fonts, 0, 0x18CF00, false, true);
		setBounds(id, 102, 63, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1240, 92, 32, "Add to ignore", -1, id + hover, 5);
		setBounds(id, 382, 268, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1241, 92, 32, id + hover + 1);
		setBounds(id + hover, 382, 268, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1243, 92, 32, "Write a message", -1, id + hover, 5);
		setBounds(id, 287, 268, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1244, 92, 32, id + hover + 1);
		setBounds(id + hover, 287, 268, frame, tab);
		frame++;
		id++;
		hover += 50;
	}

	public static void equipmentScreenNew() {
		playersOnline();
		questJournalTab();
		int id = 65234;
		...
		final String[][] STRING_ID = { { "1675", "Stab", "0xC98C3D", }, { "1676", "Slash", "0xC98C3D" },
				{ "1677", "Crush", "0xC98C3D" }, { "1678", "Magic", "0x6171E6" }, { "1679", "Range", "0x20A203" },
				{ "1680", "Stab", "0xC98C3D" }, { "1681", "Slash", "0xC98C3D" }, { "1682", "Crush", "0xC98C3D" },
				{ "1683", "Magic", "0x6171E6" }, { "1684", "Range", "0x20A203" },

				{ "16522", "Summoning", "0x1AEF7E", }, { "16523", "Absorb Melee", "0x989898", },
				{ "16524", "Absorb Magic", "0x989898" }, { "16525", "Absorb Ranged", "0x989898" },

				{ "1686", "Strength", "0x989898" }, { "16526", "Ranged Strength", "0x989898" },
				{ "1687", "Prayer", "0x989898" }, { "16527", "Magic Damage", "0x989898" } };

		final int[] colours = { 0xC98C3D, 0xC98C3D, 0xC98C3D, 0x6171E6, 0x20A203, 0xC98C3D, 0xC98C3D, 0xC98C3D,
				0x6171E6, 0x20A203,

				0x1AEF7E, 0x989898, 0x989898, 0x989898, 0x989898, 0x989898, 0x989898, 0x989898, 0x989898, 0x989898,
				0x989898 };

		for (int i = 0; i < STRING_ID.length; i++) {
			addText(Integer.parseInt(STRING_ID[i][0]), "", fonts, 0, colours[i], false, false);
		}

		tab.child(frame, 16527, 132, 297);
		frame++;
		id++;

		tab.child(frame, 1687, 97, 297);
		frame++;
		id++;

		tab.child(frame, 16526, 64, 297);
		frame++;
		id++;

		tab.child(frame, 1686, 27, 297);
		frame++;
		id++;

		tab.child(frame, 16525, 132, 248);
		frame++;
		id++;

		tab.child(frame, 16524, 100, 248);
		frame++;
		id++;

		tab.child(frame, 16523, 64, 248);
		frame++;
		id++;

		tab.child(frame, 16522, 27, 248);
		frame++;
		id++;

		tab.child(frame, 1675, 60, 90);
		frame++;
		id++;

		tab.child(frame, 1676, 60, 105);
		frame++;
		id++;

		tab.child(frame, 1677, 60, 120);
		frame++;
		id++;

		tab.child(frame, 1678, 130, 90);
		frame++;
		id++;

		tab.child(frame, 1679, 130, 105);
		frame++;
		id++;

		tab.child(frame, 1680, 60, 182);
		frame++;
		id++;

		tab.child(frame, 1681, 60, 197);
		frame++;
		id++;

		tab.child(frame, 1682, 60, 212);
		frame++;
		id++;

		tab.child(frame, 1683, 130, 182);
		frame++;
		id++;

		tab.child(frame, 1684, 130, 197);
		frame++;
		id++;

		tab.child(frame, 15125, 170, 200);
		frame++;
		id++;
		...
		addHoverButtonWSpriteLoader(id, 1229, 38, 38, "Amulet", -1, id + hover, 0);
		setBounds(id, 398, 123, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1228, 38, 38, id + hover + 1);
		setBounds(id + hover, 398, 123, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1229, 38, 38, "Arrows", -1, id + hover, 0);
		setBounds(id, 439, 123, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1228, 38, 38, id + hover + 1);
		setBounds(id + hover, 439, 123, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1229, 38, 38, "Boots", -1, id + hover, 0);
		setBounds(id, 398, 242, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1228, 38, 38, id + hover + 1);
		setBounds(id + hover, 398, 242, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1229, 38, 38, "Cape", -1, id + hover, 0);
		setBounds(id, 357, 123, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1228, 38, 38, id + hover + 1);
		setBounds(id + hover, 357, 123, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1229, 38, 38, "Gloves", -1, id + hover, 0);
		setBounds(id, 342, 242, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1228, 38, 38, id + hover + 1);
		setBounds(id + hover, 342, 242, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1229, 38, 38, "Helm", -1, id + hover, 0);
		setBounds(id, 398, 84, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1228, 38, 38, id + hover + 1);
		setBounds(id + hover, 398, 84, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1229, 38, 38, "Legs", -1, id + hover, 0);
		setBounds(id, 398, 242 - 40, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1228, 38, 38, id + hover + 1);
		setBounds(id + hover, 398, 242 - 40, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1229, 38, 38, "Boots", -1, id + hover, 0);
		setBounds(id, 454, 242, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1228, 38, 38, id + hover + 1);
		setBounds(id + hover, 454, 242, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1229, 38, 38, "Shield", -1, id + hover, 0);
		setBounds(id, 454, 162, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1228, 38, 38, id + hover + 1);
		setBounds(id + hover, 454, 162, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1229, 38, 38, "Body", -1, id + hover, 0);
		setBounds(id, 398, 162, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1228, 38, 38, id + hover + 1);
		setBounds(id + hover, 398, 162, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1229, 38, 38, "Weapon", -1, id + hover, 0);
		setBounds(id, 342, 162, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1228, 38, 38, id + hover + 1);
		setBounds(id + hover, 342, 162, frame, tab);
		frame++;
		id++;
		hover += 50;

		tab.child(frame, 1688, 50 + 297 - 2, 125);
		frame++;
		id++;
	...
	public static void book() {
		...
		tab.child(frame, id, 0 + x_o, 35 + y_o);
		frame++;
		id++;

		addHDSpriteLoader(id, 1200);
		tab.child(frame, id, 2 + x_o, 0 + y_o);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1058, 18, 18, "Close", -1, id + 90, 3);
		setBounds(id, 195 + 274 + x_o, 6 + y_o, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 90, 1059, 18, 18, id + 91);
		setBounds(id + 90, 195 + 274 + x_o, 6 + y_o, frame, tab);
		frame++;
		id++;
		...
		for (int i = 0; i < 10; i++) {
			addText(id, "", fonts, 0, 0, true, false);
			setBounds(id, 130 + x_o, y + y_o, frame, tab);
			frame++;
			id++;
			addText(id, "", fonts, 0, 0, true, false);
			setBounds(id, 358 + x_o, y + y_o, frame, tab);
			frame++;
			id++;
			y += 18;
		}

		addText(id, "", fonts, 3, 0xee1e1e, true, true);
		setBounds(id, 254 + x_o, 6 + y_o, frame, tab);
		frame++;
		id++;

		addText(id, "1", fonts, 0, 0, false, false);
		setBounds(id, 25 + x_o, 255 + y_o, frame, tab);
		frame++;
		id++;

		addText(id, "2", fonts, 0, 0, false, false);
		setBounds(id, 455 + x_o, 255 + y_o, frame, tab);
		frame++;
		id++;

		// first book
		tab = addTabInterface(58570);
		id++;
		frame = 0;

		tab.totalChildren(3);

		tab.child(frame, 58510, 0, 0);
		frame++;
		id++;

		int hover = 100;

		addHoverButtonWSpriteLoader(id, 1203, 197, 38, "Forward", -1, id + hover, 5);
		setBounds(id, 430, 290, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1204, 197, 38, id + hover + 1);
		setBounds(id + hover, 430, 290, frame, tab);
		frame++;
		id++;
		hover += 50;

		// middle book
		tab = addTabInterface(58580);
		id++;
		frame = 0;
		...
		addHoverButtonWSpriteLoader(id, 1201, 197, 38, "Back", -1, id + hover, 5);
		setBounds(id, 35, 290, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1202, 197, 38, id + hover + 1);
		setBounds(id + hover, 35, 290, frame, tab);
		frame++;
		id++;
		hover += 50;
	...
	public static void exitClient() {
		...
		id++;
		int frame = 0;
		addSpriteLoader(id, 1194);

		tab.totalChildren(5);

		tab.child(frame, id, 128, 140);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1195, 60, 28, "Exit", -1, id + 90, 5);
		setBounds(id, 190, 196, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 90, 1196, 60, 28, id + 91);
		setBounds(id + 90, 190, 196, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1197, 60, 28, "Stay", -1, id + 290, 5);
		setBounds(id, 266, 196, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 290, 1198, 60, 28, id + 291);
		setBounds(id + 290, 266, 196, frame, tab);
		frame++;
		id++;
	 ...
	 * TODO nothing
	 */
	private static void StreamScapeGameSettings(TextDrawingArea[] tda) {
		RSInterface rsinterface = addTabInterface(29740);
		setChildren(28, rsinterface);

		addSpriteLoader(29741, 1285); // Backgound
		setBounds(29741, 35, 40, 0, rsinterface);

		addSpriteLoader(29742, 1286); // Top Frame Back
		setBounds(29742, 35, 40, 1, rsinterface);

		addSpriteLoader(29743, 1287); // Outer Background Frame
		setBounds(29743, 35, 40, 2, rsinterface);

		setBounds(29744, 50, 50, 3, rsinterface); // Game Settings Scroll Panel

		int frame = 3;
		int id = 29745;
		int y = 25;
		rsinterface.child(frame, id, 45, 75);
		frame++;
		...
		addText(29804, "Game Settings", fonts, 0, 0x9c9c9c, true, true);
		scroll.child(frame, id, 108, y - 20);
		frame++;
		id++;

		for (int i = 0; i < 28; i++) {
			addCacheSpriteToggleButton(id, 1288, 5000 + i, 98, 16, "Toggle");
		...
		y = 25;
		for (int i = 28; i < 56; i++) {
			addCacheSpriteToggleButton(id, 1288, 1234 + i, 98, 16, "Toggle");
			scroll.child(i, id, 99, y);
			y += 14;
			id++;
		}
		y = 27;
		id = 29810;
		addText(id, "AntiAliasing", fonts, 0, 0x9c9c9c, false, true);
		scroll.child(56, id, 5, y);
		y += 14;
		id++;

		addText(id, "G. Texturing", fonts, 0, 0x9c9c9c, false, true);
		scroll.child(57, id, 5, y);
		y += 14;
		id++;

		addText(id, "Tip Hovers", fonts, 0, 0x9c9c9c, false, true);
		scroll.child(58, id, 5, y);
		y += 14;
		id++;

		addText(id, "Hitmarkers", fonts, 0, 0x9c9c9c, false, true);
		scroll.child(59, id, 5, y);
		y += 14;
		id++;

		addText(id, "x10 Hits", fonts, 0, 0x9c9c9c, false, true);
		scroll.child(60, id, 5, y);
		y += 14;
		id++;

		addText(id, "New Cursors", fonts, 0, 0x9c9c9c, false, true);
		scroll.child(61, id, 5, y);
		y += 14;
		id++;

		addText(id, "Smilies", fonts, 0, 0x9c9c9c, false, true);
		scroll.child(62, id, 5, y);
		y += 14;
		id++;

		addText(id, "Save Input", fonts, 0, 0x9c9c9c, false, true);
		scroll.child(63, id, 5, y);
		y += 14;
		id++;

		addText(id, "Shift Click", fonts, 0, 0x9c9c9c, false, true);
		scroll.child(74, id, 5, y);
		y += 14;
		id++;

		addText(id, "Smash vial (0)", fonts, 0, 0x9c9c9c, false, true);
		scroll.child(75, id, 5, y);
		y += 14;
		id++;
		 ...
		 */
		y = 27;
		addText(id, "Chat Censor", fonts, 0, 0x9c9c9c, false, true);
		scroll.child(64, id, 104, y);
		y += 14;
		id++;

		addText(id, "Fog Rendering", fonts, 0, 0x9c9c9c, false, true);
		scroll.child(65, id, 104, y);
		y += 14;
		id++;

		addText(id, "Absoption", fonts, 0, 0x9c9c9c, false, true);
		scroll.child(66, id, 104, y);
		y += 14;
		id++;

		addText(id, "Game Settings", fonts, 0, 0x9c9c9c, true, true);
		scroll.child(67, id, 108, 8);
		id++;

		addSpriteLoader(29843, 1304); // Center Div
		setBounds(29843, 262, 75, 4, rsinterface);

		addSpriteLoader(29844, 1290); // Brightness Box Back
		setBounds(29844, 270, 80, 5, rsinterface);

		addSpriteLoader(29845, 1291); // Volume Box Back
		setBounds(29845, 270, 150, 6, rsinterface);

		addSpriteLoader(29846, 1292); // Sizing Box Back
		setBounds(29846, 270, 220, 7, rsinterface);

		addSlider(29848, 0.6, 1.5, 1294, 1293, 1);
		setBounds(29848, 335, 113, 8, rsinterface);

		addSpriteLoader(29849, 1295); // Brightness Icon
		setBounds(29849, 287, 106, 9, rsinterface);

		addSlider(29850, -50.00, 300.00, 1297, 1296, 2);
		setBounds(29850, 358, 171, 10, rsinterface);

		addSlider(29851, 0.0, 4.5, 1297, 1296, 3);
		setBounds(29851, 358, 185, 11, rsinterface);

		addSlider(29852, 0.6, 1.5, 1297, 1296, 4);
		setBounds(29852, 358, 199, 12, rsinterface);

		addText(29853, "Game Settings", fonts, 3, 0x990000, true, true);
		setBounds(29853, 270, 45, 13, rsinterface);

		addText(29854, "Brightness", fonts, 0, 0xC3C1C1, true, false);
		setBounds(29854, 372, 87, 14, rsinterface);

		addHoverButtonWSpriteLoader(5384, 1272, 18, 18, "Close Window", 0, 5380, 1);
		addHoveredImageWSpriteLoader(5380, 1273, 18, 18, 5379);
		setBounds(5384, 461, 47, 15, rsinterface);
		setBounds(5380, 461, 47, 16, rsinterface);

		addText(29855, "Volume", fonts, 0, 0xC3C1C1, true, false);
		setBounds(29855, 372, 154, 17, rsinterface);

		addText(29856, "Music", fonts, 0, 0xC3C1C1, true, false);
		setBounds(29856, 292, 171, 18, rsinterface);

		addText(29857, "Sound Effects", fonts, 0, 0xC3C1C1, true, false);
		setBounds(29857, 313, 185, 19, rsinterface);

		addText(29858, "Area Sounds", fonts, 0, 0xC3C1C1, true, false);
		setBounds(29858, 310, 198, 20, rsinterface);

		addText(29859, "Screen Sizing", fonts, 0, 0xC3C1C1, true, false);
		setBounds(29859, 372, 225, 21, rsinterface);

		addHoverButtonWSpriteLoader(29860, 1298, 50, 39, "Fixed", -1, 29861, 1);
		addHoveredImageWSpriteLoader(29861, 1299, 50, 39, 29862);
		setBounds(29860, 278, 242, 22, rsinterface);
		setBounds(29861, 278, 242, 23, rsinterface);

		addHoverButtonWSpriteLoader(29863, 1300, 50, 39, "Resizable", -1, 29864, 1);
		addHoveredImageWSpriteLoader(29864, 1301, 50, 39, 29865);
		setBounds(29863, 345, 242, 24, rsinterface);
		setBounds(29864, 345, 242, 25, rsinterface);

		addHoverButtonWSpriteLoader(29866, 1302, 50, 39, "Fullscreen", -1, 29867, 1);
		addHoveredImageWSpriteLoader(29867, 1303, 50, 39, 29868);
		setBounds(29866, 412, 242, 26, rsinterface);
		setBounds(29867, 412, 242, 27, rsinterface);

		addText(id, "Roofs", fonts, 0, 0x9c9c9c, false, true);
		scroll.child(68, id, 104, y);
		y += 14;
		id++;

		addText(id, "HP Bars", fonts, 0, 0x9c9c9c, false, true);
		scroll.child(69, id, 104, y);
		y += 14;
		id++;

		addText(id, "Hp Numerals", fonts, 0, 0x9c9c9c, false, true);
		scroll.child(70, id, 104, y);
		y += 14;
		id++;

		addText(id, "Head Crowns", fonts, 0, 0x9c9c9c, false, true);
		scroll.child(71, id, 104, y);
		y += 14;
		id++;

		addText(id, "HD Minimap", fonts, 0, 0x9c9c9c, false, true);
		scroll.child(72, id, 104, y);
		y += 14;
		id++;

		addText(id, "Chat Effects", fonts, 0, 0x9c9c9c, false, true);
		scroll.child(73, id, 104, y);
		y += 14;
		id++;
	 ...
	 * Bank of StreamScape
	 */
	private static void theBankOfStreamScape(TextDrawingArea[] tda) {
		RSInterface rsinterface = addTabInterface(5292);
		setChildren(54, rsinterface);

		setBounds(5383, -300, -513, 6, rsinterface);
		addSpriteLoader(5293, 913); // Backgound
		setBounds(5293, 5, 5, 0, rsinterface);

		addSpriteLoader(24810, 1271); // Backgound Header Frame
		setBounds(24810, 10, 10, 3, rsinterface);

		addSpriteLoader(24805, 1261); // Backgound Frame
		setBounds(24805, 5, 5, 27, rsinterface);

		addSpriteLoader(24809, 1270); // Item Container Background
		setBounds(24809, 20, 91, 1, rsinterface);

		addSpriteLoader(24807, 1265); // Items Background Frame
		setBounds(24807, 16, 87, 15, rsinterface);

		addSpriteLoader(24806, 1263); // Backgound Options Frame
		setBounds(24806, 5, 283, 26, rsinterface);

		addText(5383, "", 0xE60000, true, true, fonts[0]);
		interfaceCache[5385].width = 474;
		interfaceCache[5385].height = 189;
		interfaceCache[5382].width = 10;
		interfaceCache[5382].invSpritePadX = 12;
		interfaceCache[5382].height = 35;

		addText(24820, "The Bank Of StreamScape", fonts, 3, 0x990000, true, true);
		setBounds(24820, 255, 15, 4, rsinterface);

		setBounds(5385, 0, 93, 14, rsinterface);

		addSpriteLoader(24808, 1266); // Item Count Background
		setBounds(24808, 442, 47, 5, rsinterface);

		addButtonWSpriteLoader(27014, 1268, "View Main");
		setBounds(27014, 18, 47, 7, rsinterface);
		addButtonWSpriteLoader(27015, 926, "Open");
		setBounds(27015, 78, 47, 8, rsinterface);
		addButtonWSpriteLoader(27016, 926, "Open");
		setBounds(27016, 138, 47, 9, rsinterface);
		addButtonWSpriteLoader(27017, 926, "Open");
		setBounds(27017, 198, 47, 10, rsinterface);
		addButtonWSpriteLoader(27018, 926, "Open");
		setBounds(27018, 258, 47, 11, rsinterface);
		addButtonWSpriteLoader(27019, 926, "Open");
		setBounds(27019, 318, 47, 12, rsinterface);
		addButtonWSpriteLoader(27020, 926, "Open");
		setBounds(27020, 378, 47, 13, rsinterface);
		addButtonWSpriteLoader(27021, 926, "Open");
		setBounds(27014, 18, 47, 7, rsinterface);
		addButtonWSpriteLoader(27022, 926, "Open");
		setBounds(27022, 414, 47, 2, rsinterface);

		addHoverButtonWSpriteLoader(5384, 1272, 18, 18, "Close Window", 0, 5380, 1);
		addHoveredImageWSpriteLoader(5380, 1273, 18, 18, 5379);
		setBounds(5384, 476, 16, 28, rsinterface);
		setBounds(5380, 476, 16, 29, rsinterface);

		addHoverButtonWSpriteLoader(22012, 1313, 27, 25, "Deposit carried items", -1, 22013, 1);
		addHoveredImageWSpriteLoader(22013, 1314, 37, 25, 22014);
		setBounds(22012, 330, 290, 30, rsinterface);
		setBounds(22013, 330, 290, 31, rsinterface);

		addHoverButtonWSpriteLoader(27005, 1315, 37, 25, "Deposit worn items", -1, 27006, 1);
		addHoveredImageWSpriteLoader(27006, 1316, 37, 25, 27007);
		setBounds(27005, 372, 290, 32, rsinterface);
		setBounds(27006, 372, 290, 33, rsinterface);

		addHoverButtonWSpriteLoader(27023, 1319, 37, 25, "Deposit Beast of Burden's inventory", -1, 27024, 1);
		addHoveredImageWSpriteLoader(27024, 1320, 37, 25, 27025);
		setBounds(27023, 455, 290, 34, rsinterface);
		setBounds(27024, 455, 290, 35, rsinterface);

		addHoverButtonWSpriteLoader(5294, 1307, 37, 25, "Manage Bank PIN", -1, 22045, 1);
		addHoveredImageWSpriteLoader(22045, 1308, 37, 25, 22046);
		setBounds(5294, 110, 290, 36, rsinterface);
		setBounds(22045, 110, 290, 37, rsinterface);

		addHoverButtonWSpriteLoader(27009, 1317, 37, 25, "Deposit Money-Pouch", -1, 27010, 1);
		addHoveredImageWSpriteLoader(27010, 1318, 37, 25, 27011);
		setBounds(27009, 414, 290, 38, rsinterface);
		setBounds(27010, 414, 290, 39, rsinterface);

		addBankHover(22016, 4, 22017, 13, 15, "Interfaces/BANK/BANK", 27, 25, 117, 1, "Swap", 22018, 14, 16,
				"Interfaces/BANK/BANK", 22019, "Click to switch insert\nbank", "Click to switch insert\nbank", 37, 25,
				1309, 1310);
		setBounds(22016, 68, 290, 40, rsinterface);
		setBounds(22017, 68, 290, 41, rsinterface);

		addBankHover(22008, 4, 22009, 9, 11, "Interfaces/BANK/BANK", 37, 25, 115, 1, "Withdraw as Note", 22010, 10, 12,
				"Interfaces/BANK/BANK", 22011, "Search your bank\nmode", "Search your bank\nmode", 37, 25, 1311, 1312);
		setBounds(22008, 260, 290, 42, rsinterface);
		setBounds(22009, 260, 290, 43, rsinterface);

		addHoverButtonWSpriteLoader(24830, 1305, 27, 25, "Search your bank", -1, 24831, 1);
		addHoveredImageWSpriteLoader(24832, 1306, 37, 25, 24833);
		setBounds(24830, 25, 290, 44, rsinterface);
		setBounds(24832, 25, 290, 52, rsinterface);

		addText(27033, "134", fonts, 0, 0xC3C1C1, true, false);
		setBounds(27033, 467, 54, 16, rsinterface);
		addText(27034, "496", fonts, 0, 0xC3C1C1, true, false);
		setBounds(27034, 467, 71, 17, rsinterface);
		addBankItem(22035, Boolean.valueOf(false));
		setBounds(22035, 92, 55, 18, rsinterface);
		addBankItem(22036, Boolean.valueOf(false));
		setBounds(22036, 152, 55, 19, rsinterface);
		addBankItem(22037, Boolean.valueOf(false));
		setBounds(22037, 212, 55, 20, rsinterface);
		addBankItem(22038, Boolean.valueOf(false));
		setBounds(22038, 270, 55, 21, rsinterface);
		addBankItem(22039, Boolean.valueOf(false));
		setBounds(22039, 332, 55, 22, rsinterface);
		addBankItem(22040, Boolean.valueOf(false));
		setBounds(22040, 390, 55, 23, rsinterface);
		addBankItem(27041, Boolean.valueOf(false));
		setBounds(27041, 385, 55, 24, rsinterface);
		addBankItem(27042, Boolean.valueOf(false));
		setBounds(27042, 413, 55, 25, rsinterface);
		addText(27000, "0", 0xFF0000, false, true, 52, fonts, 1);
		addText(27001, "0", 0xFF0000, false, true, 52, fonts, 1);
		addText(27002, "0", 0xFF0000, false, true, 52, fonts, 1);

		addSpriteLoader(24821, 1282); // search icon
		setBounds(24821, -40, -292, 53, rsinterface);

		addSpriteLoader(24822, 1281); // bank pin icon
		setBounds(24822, -77, -293, 45, rsinterface);

		addSpriteLoader(24823, 1284); // swap slot icon
		setBounds(24823, -120, -292, 46, rsinterface);

		addSpriteLoader(24824, 1277); // swap notes
		setBounds(24824, -270, -294, 47, rsinterface);

		addSpriteLoader(24825, 1280); // deposit inv
		setBounds(24825, -335, -292, 48, rsinterface);

		addSpriteLoader(24826, 1278); // deposit equip
		setBounds(24826, -380, -292, 49, rsinterface);

		addSpriteLoader(24827, 1279); // deposit coins
		setBounds(24827, -420, -292, 50, rsinterface);

		addSpriteLoader(24828, 1283); // deposit beast
		setBounds(24828, -462, -292, 51, rsinterface);
	}
	...
	public static void bankSettings() {
		...
		id++;
		int frame = 0;
		addSpriteLoader(id, 1190);

		tab.totalChildren(8);

		tab.child(frame, id, 31, 67);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1058, 18, 18, "Close", -1, id + 90, 3);
		setBounds(id, 195 + 284 - 25, 76, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 90, 1059, 18, 18, id + 91);
		setBounds(id + 90, 195 + 284 - 25, 76, frame, tab);
		frame++;
		id++;

		int hover = 100;

		addHoverButtonWSpriteLoader(id, 1191, 197, 38, "Change your PIN", -1, id + hover, 5);
		setBounds(id, 260, 121, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1192, 197, 38, id + hover + 1);
		setBounds(id + hover, 260, 121, frame, tab);
		frame++;
		id++;
		hover += 50;
		...
		addHoverButtonWSpriteLoader(id, 1191, 197, 38, "Delete your PIN", -1, id + hover, 5);
		setBounds(id, 260, 165, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1192, 197, 38, id + hover + 1);
		setBounds(id + hover, 260, 165, frame, tab);
		frame++;
		id++;
		hover += 50;

		addText(id, "You have a PIN", fonts, 3, 0xee1e1e, true, true);
		setBounds(id, 154, 165, frame, tab);
		frame++;
		id++;
	}

	public static void bankPinInterface() {
		bankSettings();
		int id = 37535;
		...
		addHoverButtonWSpriteLoader(id, 1180, 72, 72, "Select", -1, id + hover, 5);
		setBounds(id, 21, 73, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1181, 72, 72, id + hover + 1);
		setBounds(id + hover, 21, 73, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1180, 72, 72, "Select", -1, id + hover, 5);
		setBounds(id, 105, 73, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1181, 72, 72, id + hover + 1);
		setBounds(id + hover, 105, 73, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1180, 72, 72, "Select", -1, id + hover, 5);
		setBounds(id, 189, 73, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1181, 72, 72, id + hover + 1);
		setBounds(id + hover, 189, 73, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1180, 72, 72, "Select", -1, id + hover, 5);
		setBounds(id, 21, 153, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1181, 72, 72, id + hover + 1);
		setBounds(id + hover, 21, 153, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1180, 72, 72, "Select", -1, id + hover, 5);
		setBounds(id, 105, 153, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1181, 72, 72, id + hover + 1);
		setBounds(id + hover, 105, 153, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1180, 72, 72, "Select", -1, id + hover, 5);
		setBounds(id, 189, 153, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1181, 72, 72, id + hover + 1);
		setBounds(id + hover, 189, 153, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1180, 72, 72, "Select", -1, id + hover, 5);
		setBounds(id, 21, 233, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1181, 72, 72, id + hover + 1);
		setBounds(id + hover, 21, 233, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1180, 72, 72, "Select", -1, id + hover, 5);
		setBounds(id, 105, 233, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1181, 72, 72, id + hover + 1);
		setBounds(id + hover, 105, 233, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1180, 72, 72, "Select", -1, id + hover, 5);
		setBounds(id, 189, 233, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1181, 72, 72, id + hover + 1);
		setBounds(id + hover, 189, 233, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1180, 72, 72, "Select", -1, id + hover, 5);
		setBounds(id, 273, 233, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1181, 72, 72, id + hover + 1);
		setBounds(id + hover, 273, 233, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1186, 140, 40, "I don't know", -1, id + hover, 5);
		setBounds(id, 352, 233, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1187, 140, 40, id + hover + 1);
		setBounds(id + hover, 352, 233, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1188, 78, 30, "Support", -1, id + hover, 5);
		setBounds(id, 352, 275, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1189, 140, 40, id + hover + 1);
		setBounds(id + hover, 352, 275, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1182, 29, 30, "Visit forums", -1, id + hover, 5);
		setBounds(id, 432, 275, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1183, 29, 30, id + hover + 1);
		setBounds(id + hover, 432, 275, frame, tab);
		frame++;
		id++;
		hover += 50;

		addHoverButtonWSpriteLoader(id, 1184, 29, 30, "Open Settings", -1, id + hover, 5);
		setBounds(id, 463, 275, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover, 1185, 29, 30, id + hover + 1);
		setBounds(id + hover, 463, 275, frame, tab);
		frame++;
		id++;
		hover += 50;
		...
		int x = 50;
		int y = 80;
		for (int i = 14883; i < 14892; i++) {
			addText(i, "0", fonts, 3, 0xee1e1e, false, true);
			setBounds(i, x, y, frame, tab);
			frame++;
			x += 90;
			if (x == 320) {
				y += 90;
		...
		addText(14892, "0", fonts, 3, 0xee1e1e, false, true);
		setBounds(14892, 300, 275, frame, tab);
		frame++;

		addText(15313, "Click the FOURTH digit", fonts, 1, 0xffffff, true, true);
		setBounds(15313, 380, 127, frame, tab);
		frame++;

		setBounds(14913, 328, 173, frame, tab);
		frame++;
		setBounds(14914, 358, 173, frame, tab);
		frame++;
		setBounds(14915, 388, 173, frame, tab);
		frame++;
		setBounds(14916, 418, 173, frame, tab);
		frame++;

		addText(id, "I don't know it", fonts, 1, 0x9c9c9c, false, true);
		setBounds(id, 380, 246, frame, tab);
		frame++;
		id++;

		addText(id, "Support", fonts, 1, 0x9c9c9c, false, true);
		setBounds(id, 370, 282, frame, tab);
		frame++;
		id++;
	}

	public static void newTradeConfirm() {
		bankPinInterface();
		int id = 34230;
		...
		addHoverButtonWSpriteLoader(id, 1163, 82, 27, "Accept", -1, id + 400, 5);
		setBounds(id, 168, 288, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 400, 1164, 82, 27, id + 400 + 1);
		setBounds(id + 400, 168, 288, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1165, 82, 27, "Decline", -1, id + 500, 5);
		setBounds(id, 260, 288, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 500, 1166, 82, 27, id + 500 + 1);
		setBounds(id + 500, 260, 288, frame, tab);
		frame++;
		id++;

		id++;

		addText(id, "Username Here", fonts, 3, 0xee1e1e, false, true);
		tab.child(frame, id, 255, 16);
		frame++;
		id++;

		addText(id, "There is NO WAY to reverse a trade if you change your mind", fonts, 0, 0x9c9c9c, true, true);
		tab.child(frame, id, 257, 264);
		frame++;
		id++;

		tab.child(frame, id, 56, 91);
		frame++;
		...
		int x = 10;
		for (int i = 0; i < 28; i++) {
			addText(id, "", fonts, 0, 0x9c9c9c, true, true);
			scroll.child(i, id, 77, x);
			x += 14;
			id++;
		}

		tab.child(frame, id, 300, 91);
		frame++;

		scroll = addTabInterface(id);
		id++;
		scroll.totalChildren(28);
		scroll.width = 174;
		scroll.height = 161;
		...
		addText(id, "Accept", fonts, 3, 0x008000, true, true);
		tab.child(frame, id, 208, 292);
		frame++;
		id++;
		addText(id, "Decline", fonts, 3, 0xff0000, true, true);
		tab.child(frame, id, 300, 292);
		frame++;
		id++;
	}
	...
	public static void newTrade() {
		...
		addHoverButtonWSpriteLoader(id, 1152, 29, 30, "Withdraw from inventory", -1, id + 100, 5);
		setBounds(id, 210, 142, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 100, 1153, 29, 30, id + 100 + 1);
		setBounds(id + 100, 210, 142, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1154, 29, 30, "Deposit to inventory", -1, id + 200, 5);
		setBounds(id, 242, 142, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 200, 1155, 29, 30, id + 200 + 1);
		setBounds(id + 200, 242, 142, frame, tab);
		frame++;
		id++;

		addButton(id, "Withdraw Bucks", 29, 30);
		setBounds(id, 274, 142, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1158, 82, 32, "Accept", -1, id + 400, 5);
		setBounds(id, 215, 201, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 400, 1159, 82, 32, id + 400 + 1);
		setBounds(id + 400, 215, 201, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1321, 82, 32, "Decline", -1, id + 500, 5);
		setBounds(id, 215, 242, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 500, 1166, 82, 32, id + 500 + 1);
		setBounds(id + 500, 215, 242, frame, tab);
		frame++;
		id++;
		...
		addText(id, "Username\\nhas @red@28 free\\ninventory slots.", fonts, 0, 0x9c9c9c, true, true);
		tab.child(frame, id, 257, 67);
		frame++;
		id++;

		addText(id, "Other player has\\nAccepted", fonts, 0, 0x9c9c9c, true, true);
		tab.child(frame, id, 257, 285);
		frame++;
		id++;

		addText(id, "Accept", fonts, 3, 0x008000, true, true);
		tab.child(frame, id, 257, 208);
		frame++;
		id++;
		addText(id, "Decline", fonts, 3, 0xff0000, true, true);
		tab.child(frame, id, 257, 248);
		frame++;
		id++;

		RSInterface tab14 = interfaceCache[3415];

		tab14.invSpritePadX = 9;
		tab14.invSpritePadY = -2;
		tab14 = interfaceCache[3416];

		tab14.invSpritePadX = 9;
		tab14.invSpritePadY = -2;

		tab.child(frame, 3415, 32, 92);
		frame++;
		tab.child(frame, 3416, 321, 92);
		frame++;

		addHoverButtonWSpriteLoader(id, 1156, 29, 30, "Withdraw Coins", -1, id + 300, 5);
		setBounds(id, 274, 142, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 300, 1157, 29, 30, id + 300 + 1);
		setBounds(id + 300, 274, 142, frame, tab);
		frame++;
	}

	public static RSInterface[] spells = new RSInterface[6];

	public static void wildy() {
		newTrade();
		int id = 35_000;
		RSInterface tab = addTabInterface(id);
		id++;
		...
		addHDSpriteLoader(id, 1133);
		tab.child(frame, id, 31, 42);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1134, 122, 42, "Enter Wilderness", -1, id + 100, 5);
		setBounds(id, 126, 234, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 100, 1135, 122, 42, id + 100 + 1);
		setBounds(id + 100, 126, 234, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1136, 122, 42, "Dont Enter", -1, id + 200, 5);
		setBounds(id, 264, 234, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 200, 1137, 122, 42, id + 200 + 1);
		setBounds(id + 200, 264, 234, frame, tab);
		frame++;
		id++;

		addText(id, "Enter\\nWilderness", fonts, 3, 0xFF0000, true, true);
		tab.child(frame, id, 188, 238);
		frame++;
		id++;

		addText(id, "Don't Enter", fonts, 3, 0x9c9c9c, true, true);
		tab.child(frame, id, 324, 244);
		frame++;
		id++;

	}

	public static void yellEditor() {
		wildy();
		int id = 40000;
		RSInterface tab = addTabInterface(id);
		id++;
		...
		addSpriteLoader(id, 1091);
		tab.child(frame, id, 6, 8);
		frame++;
		id++;

		addButtonWSpriteLoader(id, 1094, "Set Black");
		tab.child(frame, id, 314, 101);
		frame++;
		id++;

		addButtonWSpriteLoader(id, 1094, "Set Black");
		tab.child(frame, id, 314, 135);
		frame++;
		id++;

		addButtonWSpriteLoader(id, 1094, "Set Black");
		tab.child(frame, id, 199, 101);
		frame++;
		id++;

		addButtonWSpriteLoader(id, 1094, "Set Black");
		tab.child(frame, id, 199, 135);
		frame++;
		id++;

		addButtonWSpriteLoader(id, 1094, "Set White");
		tab.child(frame, id, 314, 101);
		frame++;
		id++;
		...
		addConfigButtonWSpriteLoader(id, 40000, 1094, 1124, 25, 25, "Select Title Color", 1, 5, 1105, id + 200);
		setBounds(id, 199, 101, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 200, 1124, 25, 25, id + 201);
		setBounds(id + 200, 199, 101, frame, tab);
		frame++;
		id++;

		addConfigButtonWSpriteLoader(id, 40000, 1094, 1124, 25, 25, "Select Text Color", 2, 5, 1105, id + 300);
		setBounds(id, 199, 135, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 300, 1124, 25, 25, id + 301);
		setBounds(id + 300, 199, 135, frame, tab);
		frame++;
		id++;

		addConfigButtonWSpriteLoader(id, 40000, 1094, 1124, 25, 25, "Select Title Shadow Color", 3, 5, 1105, id + 400);
		setBounds(id, 314, 101, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 400, 1124, 25, 25, id + 401);
		setBounds(id + 400, 314, 101, frame, tab);
		frame++;
		id++;

		addConfigButtonWSpriteLoader(id, 40000, 1094, 1124, 25, 25, "Select Text Shadow Color", 4, 5, 1105, id + 500);
		setBounds(id, 314, 135, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 500, 1124, 25, 25, id + 501);
		setBounds(id + 500, 314, 135, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1095, 122, 32, "Confirm Selection", -1, id + 50, 5);
		setBounds(id, 247, 276, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 50, 1096, 122, 32, id + 51);
		setBounds(id + 50, 247, 276, frame, tab);
		frame++;
		id++;
		...
		addHoverButtonWSpriteLoader(id, 1122, 302, 18, "Select Yell Title", -1, id + 100, 5);
		setBounds(id, 166, 224, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 100, 1123, 302, 18, id + 101);
		setBounds(id + 100, 166, 224, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1125, 92, 22, "Save Preset", -1, id + 600, 5);
		setBounds(id, 153, 281, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 600, 1126, 92, 22, id + 601);
		setBounds(id + 600, 153, 281, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1127, 13, 11, "Remove Preset 1", -1, id + 700, 5);
		setBounds(id, 391, 291, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 700, 1130, 13, 11, id + 701);
		setBounds(id + 700, 391, 291, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1128, 13, 11, "Use Preset 1", -1, id + 800, 5);
		setBounds(id, 391, 281, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 800, 1129, 13, 11, id + 801);
		setBounds(id + 800, 391, 281, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1127, 13, 11, "Remove Preset 2", -1, id + 900, 5);
		setBounds(id, 391 + 38, 291, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 900, 1130, 13, 11, id + 901);
		setBounds(id + 900, 391 + 38, 291, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1128, 13, 11, "Use Preset 2", -1, id + 950, 5);
		setBounds(id, 391 + 38, 281, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 950, 1129, 13, 11, id + 951);
		setBounds(id + 950, 391 + 38, 281, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1127, 13, 11, "Remove Preset 3", -1, id + 900, 5);
		setBounds(id, 391 + 38 + 38, 291, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 900, 1130, 13, 11, id + 901);
		setBounds(id + 900, 391 + 38 + 38, 291, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1128, 13, 11, "Use Preset 3", -1, id + 990, 5);
		setBounds(id, 391 + 38 + 38, 281, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 990, 1129, 13, 11, id + 991);
		setBounds(id + 990, 391 + 38 + 38, 281, frame, tab);
		frame++;
		id++;
	}

	public static int config = 1200;


	//teleport tabs
	public static void addTeleportTabs(int id, String[] NAME, int[] sprites, int[] hovers) {
		RSInterface scroll = addTabInterface(id);


		int id2 = id+ 5000;
		RSInterface tab = addTabInterface(id2);
	...
	int frame2 = 0;
		...
		scroll.totalChildren(1);
			...
			scroll.child(frame2, id2, 0+15, 45);
			frame2++;
			id2+=1000;
		...
		tab.totalChildren((NAME.length * 6));
		...
		for (int i = 0; i < NAME.length; i++) {
			...
			addHoverButtonWSpriteLoader(id, sprites[i], 500, 30, "Teleport", -1, id + hover, 5);
			setBounds(id, x + 100, y, frame, tab);
			frame++;

			addHoveredImageWSpriteLoader(id + hover, hovers[i], 500, 30, id + hover + 1);
			setBounds(id + hover, x + 100, y, frame, tab);
			frame++;
			id++;

			addText(id, NAME[i], fonts, 0, 0xffffff, true, true);
			tab.child(frame, id, x + 302, y+10);
			frame++;
			id++;


			addHoverButtonWSpriteLoader(id, 1089, 14, 14, "", -1, id + 3700, 0);
			setBounds(id, x + 204, y+935, frame, tab);
			frame++;
			addHoveredImageWSpriteLoader(id + 3700, 1131, 14, 14, id + 3701);
			setBounds(id + 3700, x +935, y+3, frame, tab);
			frame++;
			id++;

			addConfigButtonWSpriteLoader(id + 2500, id, 1062, 1090, 15, 15, "Select Favorite", 0, 5, config);
			tab.child(frame, id + 2500, x + 935, y+3);
			frame++;
			id++;
	...
	//teleport tabs
	public static void addTeleportTab(int id, int x, int y, String[] NAME, int[] sprite, int[] hover) {
		RSInterface tab = addTabInterface(id);
		...
		tab.child(frame, 49000, 0, 0);
		frame++;
		id++;

		addSpriteLoader(id, 1340);
		tab.child(frame, id, 20, y);
		frame++;
		id++;

		addTeleportTabs(id, NAME, sprite, hover);
		tab.child(frame, id, 0, 0);
		frame++;
		id++;

		tab.child(frame, 49890, 0, 0);
		frame++;
		id++;
		...
		x = 86;
		y = 3;
		addText(id, "Melee", fonts, 0, 0x989898, true, true);
		tab.child(frame, id, x, 72-y);
		frame++;
		id++;

		addText(id, "Mage", fonts, 0, 0x989898, true, true);
		tab.child(frame, id, x, 106-y);
		frame++;
		id++;

		addText(id, "Range", fonts, 0, 0x989898, true, true);
		tab.child(frame, id, x, 142-y);
		frame++;
		id++;

		addText(id, "Bosses", fonts, 0, 0x989898, true, true);
		tab.child(frame, id, x, 177-y);
		frame++;
		id++;

		addText(id, "Mini-game", fonts, 0, 0x989898, true, true);
		tab.child(frame, id, x, 212-y);
		frame++;
		id++;

		addText(id, "Donator", fonts, 0, 0x989898, true, true);
		tab.child(frame, id, x, 247-y);
		frame++;
		id++;

		addText(id, "Other zones", fonts, 0, 0x989898, true, true);
		tab.child(frame, id, x, 282-y);
		frame++;
		id++;

	}

	public static void createTeleports() {
		addTeleportTab(49100, 400, 61,
				new String[] { "Key Zone", "Purgatory", "Drygore Gods", "Dagganoth Slayer",
						"Anouke", "Golden Tormented demons", "Coming Soon", "Coming Soon" },
				new int[] { 1336, 1336, 1336, 1336, 1336, 1336, 1336, 1336 },
				new int[] { 1338, 1338, 1338, 1338, 1338, 1338, 1338, 1338 });
		addTeleportTab(49200, 400, 96,
				new String[] { "Fire Draconian mage", "Ice Draconian mage", "Toxic Draconian mage" },
				new int[] { 1336, 1336, 1336, }, new int[] { 1338, 1338, 1338 });
		addTeleportTab(49300, 28, 131, new String[] { "Fire Draconian ranger", "Ice Draconian ranger", "Toxic Draconian ranger" },
				new int[] { 1336, 1336, 1336 }, new int[] { 1338, 1338, 1338 });
		addTeleportTab(49400, 28, 166,
				new String[] { "Shodow Corporeal Beast", "Ichigo", "Coming Soon",
						"Coming Soon" },
				new int[] { 1336, 1336, 1336, 1336 }, new int[] { 1338, 1338, 1338, 1338 });
			addTeleportTab(49500, 28, 201, new String[] { "Hunger games", "Gods Raid", },
				new int[] { 1336, 1336, }, new int[] { 1338, 1338, });
		addTeleportTab(49600, 28, 236, new String[] { "Donor", "Deluxe Donor", "Sponsor", },
				new int[] { 1336, 1336, 1336 }, new int[] { 1338, 1338, 1338 });
		addTeleportTab(49700, 28, 236, new String[] { "Gamble", "Duel area", },
				new int[] { 1336, 1336}, new int[] { 1338, 1338});
	}

	public static void dropp(final TextDrawingArea[] tda) {
	...
	public static void teleportInterface() {
		...
		addHoverButtonWSpriteLoader(id, 1058, 18, 18, "Close", -1, id + 50, 3);
		setBounds(id, 195 + 284, 17, frame, tab);
		frame++;

		addHoveredImageWSpriteLoader(id + 50, 1059, 18, 18, id + 51);
		setBounds(id + 50, 195 + 284, 17, frame, tab);
		frame++;
		id++;

		id = 49890;
		tab = addTabInterface(id);
		...
		addHoverButtonWSpriteLoader(id, 1341, 126, 32, "View Melee", -1, id + 70, 5);
		setBounds(id, 20, 61, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 70, 1340, 126, 32, id + 71);
		setBounds(id + 70, 20, 61, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1341, 126, 32, "View Mage", -1, id + 90, 5);
		setBounds(id, 20, 96, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 90, 1340, 126, 32, id + 91);
		setBounds(id + 90, 20, 96, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1341, 126, 32, "View Range", -1, id + 120, 5);
		setBounds(id, 20, 131, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 120, 1340, 126, 32, id + 121);
		setBounds(id + 120, 20, 131, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1341, 126, 32, "View bosses", -1, id + 140, 5);
		setBounds(id, 20, 166, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 140, 1340, 126, 32, id + 141);
		setBounds(id + 140, 20, 166, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1341, 126, 32, "View mini-game", -1, id + 160, 5);
		setBounds(id, 20, 201, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 160, 1340, 126, 32, id + 161);
		setBounds(id + 160, 20, 201, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1341, 126, 32, "View Donator", -1, id + 180, 5);
		setBounds(id, 20, 236, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 180, 1340, 126, 32, id + 181);
		setBounds(id + 180, 20, 236, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1341, 126, 32, "View Other zones", -1, id + 200, 5);
		setBounds(id, 20, 271, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 200, 1340, 126, 32, id + 201);
		setBounds(id + 200, 20, 271, frame, tab);
		frame++;
		id++;
	}
	...
	public static void accountSetup() {
		...
		addText(id,
				...
				fonts, 0, 0x989898, true, true);
		tab.child(frame, id, 256, 94);
		frame++;
		id++;

		addConfigButtonWSpriteLoader(id, 47000, 1049, 1050, 122, 32, "Select Normal Mode", 0, 5, 1085, id + 200);
		setBounds(id, 50, 61, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 200, 1050, 122, 32, id + 201);
		setBounds(id + 200, 50, 61, frame, tab);
		frame++;
		id++;

		addConfigButtonWSpriteLoader(id, 47000, 1051, 1052, 122, 32, "Select Ironman Mode", 1, 5, 1085, id + 300);
		setBounds(id, 195, 61, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 300, 1052, 122, 32, id + 301);
		setBounds(id + 300, 195, 61, frame, tab);
		frame++;
		id++;

		addConfigButtonWSpriteLoader(id, 47000, 1053, 1054, 122, 32, "Select Hardcore", 2, 5, 1085, id + 400);
		setBounds(id, 195 + 145, 61, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 400, 1054, 122, 32, id + 401);
		setBounds(id + 400, 195 + 145, 61, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1055, 122, 32, "Confirm selection", -1, id + 500, 5);
		setBounds(id, 195, 276, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 500, 1056, 122, 32, id + 501);
		setBounds(id + 500, 195, 276, frame, tab);
		frame++;
		id += 100;
		 ...
		 */
		int x = 60;
		for (int i = 59025; i < 59037; i++) {
			tab.child(frame, i, x, 180);
			frame++;
			x += 33;
		}

		int x2 = 60;
		for (int i = 59037; i < 59046; i++) {
			tab.child(frame, i, x2, 214);
			frame++;
			x2 += 33;
		}
		 ...
		 */
		int x3 = 60;
		for (int i = 59046; i < 59052; i++) {
			tab.child(frame, i, x3, 234);
			frame++;
			x3 += 33;
		}
	}

	public static void addItems(int childId, int interfaceId, String[] options, int height, int width) {
		RSInterface rsi = interfaceCache[childId] = new RSInterface();
		rsi.actions = new String[10];
		rsi.spritesX = new int[28];
		rsi.inv = new int[28];
		rsi.invStackSizes = new int[28];
		rsi.spritesY = new int[28];
	...
	public static void achievementsInterface(TextDrawingArea[] tda) {
		accountSetup();
		RSInterface tab = addTabInterface(37000);
		RSInterface scroll = addTabInterface(36999);
		addText(37001, "Achievements", tda, 1, 0xFF0000, true, true);
		addSpriteLoader(37002, 722);
		addSpriteLoader(37003, 723);
		addSpriteLoader(37004, 722);
		tab.totalChildren(5);
		...
		scroll.width = 174;
		scroll.height = 221;
		scroll.scrollMax = 1707;
		addText(72343, "Easy Tasks", fonts, 2, 0x000000, false, true);
		scroll.child(0, 72343, 6, 10);
		/** TEXT **/
		int k = 1;
		int y = 25;
		...
		addText(37038, "Medium Tasks", fonts, 2, 0x000000, false, true);
		addText(37070, "Hard Tasks", fonts, 2, 0x000000, false, true);
		addText(37099, "Elite Tasks", fonts, 2, 0x000000, false, true);
	}
	...
	public static void addButton(int id, String tooltip, int w, int h) {
		RSInterface tab = interfaceCache[id] = new RSInterface();
		tab.id = id;
		tab.parentID = id;
		tab.type = -1;
	...
	public static void addHoveredImageWSpriteLoader(int i, int spriteId, int w, int h, int imgInterface) {
		...
		tab.atActionType = 0;
		tab.contentType = 0;
		tab.opacity = (byte) (spriteId == 969 ? 128 : 0);
		tab.hoverType = -1;
		tab.scrollMax = 0;
		tab.interfaceShown = true;
		tab.width = w;
	...
	public static void addHoveredSpriteLoaderButton(int i, int w, int h, int IMAGEID, int spriteId) {
		...
		tab.hoverType = -1;
		tab.scrollMax = 0;
		addHoverImageWSpriteLoader(IMAGEID, spriteId);
		tab.totalChildren(1);
		tab.child(0, IMAGEID, 0, 0);
	}
	...
	public static void addLowerButton(int child, int hoverChild, int hoverImageChild) {
		addHoverButtonWSpriteLoader(child, 949, 16, 20, "Lower", 250, hoverChild, 4);
		addHoveredImageWSpriteLoader(hoverChild, 950, 16, 20, hoverImageChild);
	}
	...
	public static void addLunar2RunesSmallBox(int ID, int r1, int r2, int ra1, int ra2, int rune1, int lvl, String name,
		...
		addText(ID + 3, "Level " + (lvl + 1) + ": " + name, 0xFF0000, true, true, 52, 1);
	...
	public static void addPouch(int ID, int r1[], int ra1, int r2, int lvl, String name, TextDrawingArea[] TDA,
		...
		addText(ID + 3, new StringBuilder().append("Level ").append(lvl).append(": ").append(name).toString(), 0xFF0000,
				true, true, 52, 1);
	...
	public static void addRandomizeButton(int child, int hoverChild, int hoverImageChild) {
		addHoverButtonWSpriteLoader(child, 953, 72, 25, "Randomize", 250, hoverChild, 4);
		addHoveredImageWSpriteLoader(hoverChild, 954, 72, 25, hoverImageChild);
	}
	...
	public static void addScroll(int ID, int r1, int ra1, int r2, int lvl, String name, TextDrawingArea[] TDA,
		...
		addText(ID + 3, "Level " + lvl + ": " + name, 0xFF0000, true, true, 52, 1);
		addText(ID + 4, "This item requires", 0xAF6A1A, true, true, 52, 0);
	...
	public static void addSpriteLoaderButtonWithTooltipBox(int parent, int childId, int spriteId, String tooltip,
														   int hoverSpriteId, int tooltipBoxChildId, String tooltipBoxText, int tooltipx, int tooltipy) {
		RSInterface rsi = RSInterface.interfaceCache[childId] = new RSInterface();
		rsi.id = childId;
		rsi.parentID = parent;
		rsi.type = 5;
		...
		rsi.tooltip = tooltip;
		// rsi.isFalseTooltip = true;
		addTooltip2(parent, tooltipBoxChildId, tooltipBoxText, tooltipx, tooltipy);
	}
	...
	public static void addSummoningText(int i, String s, int k, boolean l, boolean m, int a, TextDrawingArea[] TDA,
		...
		RSInterface.message = s;
		com.jagex.RSInterface.textColor(i, k);
	...
	public static void addTeleportButton(int child, int hoverChild, int hoverImageChild) {
		addHoverButtonWSpriteLoader(child, 953, 72, 25, "Teleport", 250, hoverChild, 4);
		addHoveredImageWSpriteLoader(hoverChild, 954, 72, 25, hoverImageChild);
	}
	 ...
	 * @param y
	 */
	public static void insertNewChild(RSInterface rsInterface, int id, int x, int y) {
		int[] newChildren = new int[rsInterface.children.length + 1];
		int[] newChildX = new int[rsInterface.childX.length + 1];
		int[] newChildY = new int[rsInterface.childY.length + 1];

		System.arraycopy(rsInterface.children, 0, newChildren, 0, rsInterface.children.length);
		System.arraycopy(rsInterface.childX, 0, newChildX, 0, rsInterface.childX.length);
		System.arraycopy(rsInterface.childY, 0, newChildY, 0, rsInterface.childY.length);

		rsInterface.children = newChildren;
		rsInterface.childX = newChildX;
		rsInterface.childY = newChildY;
		rsInterface.children[rsInterface.children.length - 1] = id;
		rsInterface.childX[rsInterface.childX.length - 1] = x;
		rsInterface.childY[rsInterface.childY.length - 1] = y;
	}
	...
	public static void addCacheSpriteToggleButton(int id, int sprite, int setconfig, int width, int height, String s) {
	...
	public static void addTooltip2(int parent, int id, String text, int x, int y) {
		RSInterface rsinterface = addTabInterface(id);
		rsinterface.parentID = parent;
		rsinterface.type = 0;
		rsinterface.interfaceShown = true;
		rsinterface.hoverType = -1;
		addTooltipBox2(parent, id + 1, text);
		rsinterface.totalChildren(1);
	...
	public static void addTooltipBox2(int parent, int id, String text) {
		RSInterface rsi = addInterface(id);
		rsi.id = id;
		rsi.parentID = parent;
		rsi.type = 12;
	...
	private static void barrowsInterface() {
		...
		addText(37201, "Barrow Brothers:", fonts, 2, 0xFF0000, true, true);
		addText(37202, "Dharoks", fonts, 1, 0x86B404, true, true);
		addText(37203, "Veracs", fonts, 1, 0x86B404, true, true);
		addText(37204, "Ahrims", fonts, 1, 0x86B404, true, true);
		addText(37205, "Torags", fonts, 1, 0x86B404, true, true);
		addText(37206, "Guthans", fonts, 1, 0x86B404, true, true);
		addText(37207, "Karils", fonts, 1, 0x86B404, true, true);
		addText(37208, "Killcount: 2", fonts, 2, 0xFF0000, true, true);
		tab.totalChildren(8);
	...
	private static void clanChatTabInterface() {
		...
		addText(29338, "Clan Chat", 0xFF0000, true, true, fonts[1]);
		addText(29340, "Talking in: @whi@Not in chat", 0xFF0000, false, true, fonts[0]);
		addText(29454, "Lootshare: @gre@On", 0xFF0000, false, true, 52, fonts, 0);
		addText(29450, "Owner: @whi@None", 0xFF0000, false, true, fonts[0]);
		addSpriteLoader(29339, 734);
		tab.totalChildren(15);
		tab.child(0, 16126, 0, 236);
		tab.child(1, 16126, 0, 62);
		tab.child(2, 29339, 0, 62);
		tab.child(3, 29343, 0, 63);
	...
	public static void clanswarsGame(TextDrawingArea[] tda) {
		...
		addText(28550, "1", tda, 0, 0xFF0000, true, true);
		addText(28551, "1", tda, 0, 0xFF0000, true, true);
		addText(28552, "Countdown to battle:", tda, 0, 0xB17A37, true, true);
		addText(28553, "0m 10s", tda, 0, 0xFF0000, true, true);
	...
	public static void clanswarsOptions(TextDrawingArea[] tda) {
		...
		addText(28562, "Clan wars options: Challenging someone", tda, 0, 0xFF0000, true, true);
	...
	private static void colorSelectionInterface() {
		...
		// addToggleButton(39050, 0, 2, "Interfaces/colorSelection/CHECK",
		// "Toggle-Split Private Chat", 1, 4, 500, 0);
	...
	private static void combinationKeys(TextDrawingArea[] tda) {
		RSInterface tab = addTabInterface(32200);
		addTransparentSpriteWSpriteLoader(32199, 955, 125);
		addTransparentSpriteWSpriteLoader(32198, 956, 125);
		addSpriteLoader(32201, 946);
		addSpriteLoader(32202, 947);
		addText(32203, "Combination Keys", tda, 2, GREY_TEXT);
		addCloseButton(32204, 32205, 32206);
		addSpriteLoader(32207, 948);
		addSpriteLoader(32208, 948);
		addSpriteLoader(32209, 948);
		addText(32210, "0", tda, 3, 0xffffff);
		addText(32211, "0", tda, 3, 0xffffff);
		addText(32212, "0", tda, 3, 0xffffff);
		addHigherButton(32213, 32219, 32220);
		addHigherButton(32214, 32221, 32222);
		addHigherButton(32215, 32223, 32224);
		addLowerButton(32216, 32225, 32226);
		addLowerButton(32217, 32227, 32228);
		addLowerButton(32218, 32229, 32230);
		addTeleportButton(32231, 32232, 32233);
		addRandomizeButton(32234, 32235, 32236);
		addText(32237, "Teleport", tda, 0, GREY_TEXT);
		addText(32238, "Randomize", tda, 0, GREY_TEXT);
		addText(32239, "Combination keys information", tda, 2, ORANGE_TEXT);
		addText(32240, "StreamScape has certain 'hot spots' you are allowed to teleport to.", tda, 3, ORANGE_TEXT, true,
				true);
		addText(32241, "Each one of these areas have their unique key combination.", tda, 3, ORANGE_TEXT, true, true);
		addText(32242, "This interface allows you to teleport through those certain", tda, 3, ORANGE_TEXT, true, true);
		addText(32243, "'hot spots'. You can view the combination keys codes at the", tda, 3, ORANGE_TEXT, true, true);
		addText(32244, "book object at home. They're also revealed on the forums of ", tda, 3, ORANGE_TEXT, true, true);
		addText(32245, "StreamScape. The book with the unique key combinations is now", tda, 3, ORANGE_TEXT, true, true);
		addText(32246, "for sale in the general store!", tda, 3, ORANGE_TEXT, true, true);
		setChildren(39, tab);
		tab.child(2, 32201, 10, 15); // Background
		tab.child(3, 32202, 168, 30); // title background
		tab.child(4, 32203, 193, 32); // title
		tab.child(5, 32204, 467, 22); // title
		tab.child(6, 32205, 467, 22); // title

		tab.child(7, 32207, 155, 85); // title
		tab.child(8, 32208, 230, 85); // title
		tab.child(9, 32209, 305, 85); // title

		tab.child(10, 32210, 172, 93); // title
		tab.child(11, 32211, 247, 93); // title
		tab.child(12, 32212, 322, 93); // title

		tab.child(13, 32213, 168, 60); // title
		tab.child(14, 32219, 168, 60); // title

		tab.child(15, 32214, 243, 60); // title
		tab.child(16, 32221, 243, 60); // title

		tab.child(17, 32215, 318, 60); // title
		tab.child(18, 32223, 318, 60); // title

		tab.child(19, 32216, 168, 120); // title
		tab.child(20, 32225, 168, 120); // title

		tab.child(21, 32217, 243, 120); // title
		tab.child(22, 32227, 243, 120); // title

		tab.child(23, 32218, 318, 120); // title
		tab.child(24, 32229, 318, 120); // title

		tab.child(25, 32231, 383, 85); // title
		tab.child(26, 32232, 383, 85); // title

		tab.child(27, 32234, 383, 55); // title
		tab.child(28, 32235, 383, 55); // title

		tab.child(29, 32237, 398, 92); // title

		tab.child(30, 32238, 392, 62); // title
		tab.child(31, 32239, 170, 150); // title
		tab.child(32, 32240, 250, 170); // title
		tab.child(33, 32241, 250, 185); // title
		tab.child(34, 32242, 250, 200); // title
		tab.child(35, 32243, 250, 215); // title
		tab.child(36, 32244, 250, 230); // title
		tab.child(37, 32245, 250, 245); // title
		tab.child(38, 32246, 250, 260); // title
		tab.child(0, 32199, 18, 22); // Background
		tab.child(1, 32198, 17, 147); // Background
	...
	public static void curseTab(TextDrawingArea[] TDA) {
		...
		int index = 0;
		addText(687, "99/99", 0xFF0000, false, false, -1, TDA, 1);
	...
	private static void curseTabInterface() {
		...
		addText(690, "690", 0xFF0000, false, false, -1, fonts, 0);
		addText(691, "691", 0xFF0000, false, false, -1, fonts, 0);
		addText(692, "692", 0xFF0000, false, false, -1, fonts, 0);
		addText(693, "693", 0xFF0000, false, false, -1, fonts, 0);
		addText(694, "694", 0xFF0000, false, false, -1, fonts, 0);
		addText(687, "99/99", 0xFF0000, false, false, -1, fonts, 1);
	...
	public static void editClan(TextDrawingArea[] tda) {
		...
		addText(47800, "Clan name:", tda, 0, 0xFF0000, false, true);
		addText(47801, "Who can enter chat?", tda, 0, 0xFF0000, false, true);
		addText(47812, "Who can talk in chat?", tda, 0, 0xFF0000, false, true);
		addText(47813, "Who can kick from chat?", tda, 0, 0xFF0000, false, true);
	...
	public static void fornitureChooser(TextDrawingArea[] wid) {
		...
		addText(38275, "Name1", wid, 0, 0xFF0000, false);
		...
		addText(38280, "lvl1", wid, 0, 0xFF0000, false);
		setBounds(38280, 88, 89, 7, rsi);

		addText(38281, "Name2", wid, 0, 0xFF0000, false);
		...
		addText(38286, "lvl2", wid, 0, 0xFF0000, false);
		setBounds(38286, 284, 89, 13, rsi);

		addText(38287, "Name3", wid, 0, 0xFF0000, false);
		...
		addText(38292, "lvl3", wid, 0, 0xFF0000, false);
		setBounds(38292, 88, 158, 19, rsi);

		addText(38293, "Name4", wid, 0, 0xFF0000, false);
		...
		addText(38298, "lvl4", wid, 0, 0xFF0000, false);
		setBounds(38298, 284, 158, 25, rsi);

		addText(38299, "Name5", wid, 0, 0xFF0000, false);
		...
		addText(38304, "lvl5", wid, 0, 0xFF0000, false);
		setBounds(38304, 89, 228, 31, rsi);

		addText(38305, "Name6", wid, 0, 0xFF0000, false);
		...
		addText(38310, "lvl6", wid, 0, 0xFF0000, false);
		setBounds(38310, 284, 228, 37, rsi);

		addText(38311, "Name7", wid, 0, 0xFF0000, false);
		...
		addText(38316, "lvl7", wid, 0, 0xFF0000, false);
		setBounds(38316, 89, 297, 43, rsi);

		addText(38317, "Name8", wid, 0, 0xFF0000, false);
		...
		addText(38322, "lvl8", wid, 0, 0xFF0000, false);
	...
	private static void friendsTabInterface(TextDrawingArea[] tda) {
		...
		addText(5067, "Friends List", tda, 1, 0xFF0000, true, true);
		addText(5070, "Add Friend", tda, 0, 0xFF0000, false, true);
		addText(5071, "Delete Friend", tda, 0, 0xFF0000, false, true);
	...
	public static void hungerGamesInterface(TextDrawingArea[] tda) {
		...
		addText(id, "StreamScape's Hunger Games", tda, 2, 0xfff380, true, true);
	...
	public static void gambleNewInterfaces(TextDrawingArea[] tda) {
		...
		addConfigButtonWSpriteLoader(id, 30891, 1142, 1144, 77, 27, "55x2", 1, 5, 1107, id + hover);
		...
		addConfigButtonWSpriteLoader(id, 30891, 1142, 1144, 77, 27, "Flower Poker", 2, 5, 1107, id + hover);
		...
		addConfigButtonWSpriteLoader(id, 30891, 1142, 1144, 77, 27, "Dice Duel", 3, 5, 1107, id + hover);
		...
		addConfigButtonWSpriteLoader(id, 30891, 1142, 1144, 77, 27, "Black Jack", 4, 5, 1107, id + hover);
		...
		addConfigButtonWSpriteLoader(id, 30891, 1142, 1144, 77, 27, "Frosty Flower", 5, 5, 1107, id + hover);
		...
		addConfigButtonWSpriteLoader(id, 30891, 1142, 1144, 77, 27, "ABC Flowers", 6, 5, 1107, id + hover);
		...
		addConfigButtonWSpriteLoader(id, 30891, 1142, 1144, 77, 27, "Hot or Cold", 7, 5, 1107, id + hover);
		...
		addConfigButtonWSpriteLoader(id, 30891, 1142, 1144, 77, 27, "Random Game", 8, 5, 1107, id + hover);
	...
	public static void gambleInterfaces(TextDrawingArea[] tda) {
		...
		addText(id, "StreamScape's Gambling Games Selection", tda, 2, 0xCB8814, true, true);
	...
	private static void ignoreTabInterface(TextDrawingArea[] tda) {
		gambleInterfaces(tda);
		RSInterface tab = addTabInterface(5715);
		RSInterface list = interfaceCache[5716];
		addText(5717, "Ignore List", tda, 1, 0xFF0000, true, true);
		addText(5720, "Add Name", tda, 0, 0xFF0000, false, true);
		addText(5721, "Delete Name", tda, 0, 0xFF0000, false, true);
	...
	private static void itemsKeptOnDeathInterface() {
		...
		addText(17103, "Items Kept on Death", fonts, 2, 0xFF0000, false, false);
		addText(17104, "Items you will keep on death:", fonts, 1, 0xFF0000, false, false);
		addText(17105, "Items you will lose on death:", fonts, 1, 0xFF0000, false, false);
		addText(17106, "Info", fonts, 1, 0xFF0000, false, false);
	...
	public static void itemsOnDeath(TextDrawingArea[] tda) {
		...
		addText(17103, "Items Kept On Death", 0xFF0000, false, true, 0, tda, 2);
		addText(17104, "Items you will keep on death (if not skulled):", 0xFF0000, false, true, 0, tda, 2);
		addText(17105, "Items you will lose on death (if not skulled):", 0xFF0000, false, true, 0, tda, 2);
		addText(17106, "Information", 0xFF0000, false, true, 0, tda, 1);
		addText(17107, "Max items kept on death:", 0xFF0000, false, true, 0, tda, 1);
	...
	public static void itemsOnDeathDATA(TextDrawingArea[] tda) {
		...
		addText(17109, "", 0xFF0000, false, false, 0, tda, 0);
		addText(17110, "The normal amount of", 0xFF0000, false, false, 0, tda, 0);
		addText(17111, "items kept is three.", 0xFF0000, false, false, 0, tda, 0);
		addText(17112, "", 0xFF0000, false, false, 0, tda, 0);
		addText(17113, "If you are skulled,", 0xFF0000, false, false, 0, tda, 0);
		addText(17114, "you will lose all your", 0xFF0000, false, false, 0, tda, 0);
		addText(17117, "items, unless an item", 0xFF0000, false, false, 0, tda, 0);
		addText(17118, "protecting prayer is", 0xFF0000, false, false, 0, tda, 0);
		addText(17119, "used.", 0xFF0000, false, false, 0, tda, 0);
		addText(17120, "", 0xFF0000, false, false, 0, tda, 0);
		addText(17121, "Item protecting prayers", 0xFF0000, false, false, 0, tda, 0);
		addText(17122, "will allow you to keep", 0xFF0000, false, false, 0, tda, 0);
		addText(17123, "one extra item.", 0xFF0000, false, false, 0, tda, 0);
		addText(17124, "", 0xFF0000, false, false, 0, tda, 0);
		addText(17125, "The items kept are", 0xFF0000, false, false, 0, tda, 0);
		addText(17126, "selected by the server", 0xFF0000, false, false, 0, tda, 0);
		addText(17127, "and include the most", 0xFF0000, false, false, 0, tda, 0);
		addText(17128, "expensive items you're", 0xFF0000, false, false, 0, tda, 0);
		addText(17129, "carrying.", 0xFF0000, false, false, 0, tda, 0);
		addText(17130, "", 0xFF0000, false, false, 0, tda, 0);
	 ...
	 * Kills Tracker
	 */
	private static void killsTrackerTab() {
	...
	public static void loyaltyShop() { // Made quickly by Streamy
	...
	public static void lunarSpellbookInterface() {
		...
		// addLunar2RunesSmallBox(30025, 9075, 557, 0, 7, 30006, 65, "Cure
		// Plant", "Cure disease on farming patch", fonts,
		// 1, 4, 2);
		// addLunar3RunesBigBox(30032, 9075, 564, 558, 0, 0, 0, 30013, 30007,
		// 65, "Monster Examine",
		...
		// 67, "Cure Other", "Cure poisoned players",
		// fonts, 4, 8, 2);
		...
		// 70, "Cure Me", "Cures Poison", fonts, 9, 0,
		// 5);
		// addLunar2RunesSmallBox(30099, 9075, 557, 1, 1, 30006, 70, "Hunter
		// Kit", "Get a kit of hunting gear", fonts, 10,
		// 0, 5);
		// addLunar3RunesSmallBox(30122, 9075, 564, 563, 1, 1, 1, 30013, 30012,
		// 73, "Cure Group",
		// "Cures Poison on players", fonts, 13, 0, 5);
		// addLunar3RunesBigBox(30130, 9075, 564, 559, 1, 1, 4, 30013, 30008,
		// 74, "Stat Spy",
		// "Cast on another player to see their\\nskill levels", fonts, 14, 8,
		// 2);
		//
		// addLunar3RunesSmallBox(30154, 9075, 554, 556, 1, 5, 9, 30003, 30005,
		// 76, "Superglass Make",
		// "Make glass without a furnace", fonts, 17, 16, 2);
		// addLunar3RunesBigBox(30178, 9075, 564, 559, 1, 0, 4, 30013, 30008,
		// 78, "Dream",
		// "Take a rest and restore hitpoints 3\\n times faster", fonts, 20, 0,
		// 5);
		...
		// addLunar3RunesBigBox(30210, 9075, 561, 557, 2, 1, 14, 30010, 30006,
		// 82, "Fertile Soil",
		// "Fertilise a farming patch with super\\ncompost", fonts, 24, 4, 2);
		// addLunar3RunesBigBox(30218, 9075, 557, 555, 2, 11, 9, 30006, 30004,
		// 83, "Boost Potion Share",
		// "Shares a potion with up to 4 nearby\\nplayers", fonts, 25, 0, 5);
		//
		// addLunar3RunesSmallBox(30242, 9075, 557, 561, 2, 14, 0, 30006, 30010,
		// 85, "Plank Make", "Turn Logs into planks",
		// fonts, 28, 16, 5);
		// addLunar3RunesBigBox(30282, 9075, 563, 561, 2, 1, 0, 30012, 30010,
		// 90, "Energy Transfer",
		// "Spend hitpoints and SA Energy to\\n give another player hitpoints
		// and run energy", fonts, 33, 8, 2);
		// addLunar3RunesBigBox(30290, 9075, 563, 565, 2, 2, 0, 30012, 30014,
		// 91, "Heal Other",
		// "Transfer up to 75% of hitpoints\\n to another player", fonts, 34, 8,
		// 2);
		// addLunar3RunesBigBox(30298, 9075, 560, 557, 2, 1, 9, 30009, 30006,
		// 92, "Vengeance Other",
		// "Allows another player to rebound\\ndamage to an opponent", fonts,
		// 35, 8, 2);
		// addLunar3RunesSmallBox(30306, 9075, 560, 557, 3, 1, 9, 30009, 30006,
		// 93, "Vengeance",
		// "Rebound damage to an opponent", fonts, 36, 0, 5);
		// addLunar3RunesBigBox(30314, 9075, 565, 563, 3, 2, 5, 30014, 30012,
		// 94, "Heal Group",
		// "Transfer up to 75% of hitpoints to a group", fonts, 37, 0, 5);
		// addLunar3RunesBigBox(30322, 9075, 564, 563, 2, 1, 0, 30013, 30012,
		// 95, "Spellbook Swap",
		// "Change to another spellbook for 1\\nspell cast", fonts, 38, 0, 5);
		//
		// final int children = 24;
		// int[] LunarIDs = { 30017, 30025, 30032, 30040, 30048, 30056, 30091,
		// 30099, 30122, 30130, 30154, 30178, 30186,
		// 30194, 30202, 30210, 30218, 30242, 30282, 30290, 30298, 30306, 30314,
		// 30322 };
		//
		...
		// addHoverButtonWSpriteLoader(11004, 907, 18, 18, "Select", -1, 11005,
		// 1);
		...
		TextDrawingArea[] TDA = fonts;

		addLunar3RunesSmallBox(30017, 7956, 554, 555, 0, 4, 3, 30003, 30004, 64, "Bake Pie",
				"Bake pies without a stove", TDA, 0, 16, 2);
		addLunar2RunesSmallBox(30025, 7956, 557, 0, 7, 30006, 65, "Cure Plant", "Cure disease on farming patch", TDA, 1,
				4, 2);
		addLunar3RunesBigBox(30032, 7956, 564, 558, 0, 0, 0, 30013, 30007, 65, "Monster Examine",
				"Detect the combat statistics of a\\nmonster", TDA, 2, 2, 2);
		addLunar3RunesSmallBox(30040, 7956, 564, 556, 0, 0, 1, 30013, 30005, 66, "NPC Contact",
				"Speak with varied NPCs", TDA, 3, 0, 2);
		addLunar3RunesSmallBox(30048, 7956, 563, 557, 0, 0, 9, 30012, 30006, 67, "Cure Other", "Cure poisoned players",
				TDA, 4, 8, 2);
		addLunar3RunesSmallBox(30056, 7956, 555, 554, 0, 2, 0, 30004, 30003, 67, "Humidify",
				"fills certain vessels with water", TDA, 5, 0, 5);
		addLunar3RunesSmallBox(30064, 7956, 563, 557, 1, 0, 1, 30012, 30006, 68, "Moonclan Teleport",
				"Teleports you to moonclan island", TDA, 6, 0, 5);
		addLunar3RunesBigBox(30075, 7956, 563, 557, 1, 0, 3, 30012, 30006, 69, "Tele Group Moonclan",
				"Teleports players to Moonclan\\nisland", TDA, 7, 0, 5);
		addLunar3RunesSmallBox(30083, 7956, 563, 557, 1, 0, 5, 30012, 30006, 70, "Ourania Teleport",
				"Teleports you to ourania rune altar", TDA, 8, 0, 5);
		addLunar3RunesSmallBox(30091, 7956, 564, 563, 1, 1, 0, 30013, 30012, 70, "Cure Me", "Cures Poison", TDA, 9, 0,
				5);
		addLunar2RunesSmallBox(30099, 7956, 557, 1, 1, 30006, 70, "Hunter Kit", "Get a kit of hunting gear", TDA, 10, 0,
				5);
		addLunar3RunesSmallBox(30106, 7956, 563, 555, 1, 0, 0, 30012, 30004, 71, "Waterbirth Teleport",
				"Teleports you to Waterbirth island", TDA, 11, 0, 5);
		addLunar3RunesBigBox(30114, 7956, 563, 555, 1, 0, 4, 30012, 30004, 72, "Tele Group Waterbirth",
				"Teleports players to Waterbirth\\nisland", TDA, 12, 0, 5);
		addLunar3RunesSmallBox(30122, 7956, 564, 563, 1, 1, 1, 30013, 30012, 73, "Cure Group",
				"Cures Poison on players", TDA, 13, 0, 5);
		addLunar3RunesBigBox(30130, 7956, 564, 559, 1, 1, 4, 30013, 30008, 74, "Stat Spy",
				"Cast on another player to see their\\nskill levels", TDA, 14, 8, 2);
		addLunar3RunesBigBox(30138, 7956, 563, 554, 1, 1, 2, 30012, 30003, 74, "Barbarian Teleport",
				"Teleports you to the Barbarian\\noutpost", TDA, 15, 0, 5);
		addLunar3RunesBigBox(30146, 7956, 563, 554, 1, 1, 5, 30012, 30003, 75, "Tele Group Barbarian",
				"Teleports players to the Barbarian\\noutpost", TDA, 16, 0, 5);
		addLunar3RunesSmallBox(30154, 7956, 554, 556, 1, 5, 9, 30003, 30005, 76, "Superglass Make",
				"Make glass without a furnace", TDA, 17, 16, 2);
		addLunar3RunesSmallBox(30162, 7956, 563, 555, 1, 1, 3, 30012, 30004, 77, "Khazard Teleport",
				"Teleports you to Port khazard", TDA, 18, 0, 5);
		addLunar3RunesSmallBox(30170, 7956, 563, 555, 1, 1, 7, 30012, 30004, 78, "Tele Group Khazard",
				"Teleports players to Port khazard", TDA, 19, 0, 5);
		addLunar3RunesBigBox(30178, 7956, 564, 559, 1, 0, 4, 30013, 30008, 78, "Dream",
				"Take a rest and restore hitpoints 3\\n times faster", TDA, 20, 0, 5);
		addLunar3RunesSmallBox(30186, 7956, 557, 555, 1, 9, 4, 30006, 30004, 79, "String Jewellery",
				"String amulets without wool", TDA, 21, 0, 5);
		addLunar3RunesLargeBox(30194, 7956, 557, 555, 1, 9, 9, 30006, 30004, 80, "Stat Restore Pot\\nShare",
				"Share a potion with up to 4 nearby\\nplayers", TDA, 22, 0, 5);
		addLunar3RunesSmallBox(30202, 7956, 554, 555, 1, 6, 6, 30003, 30004, 81, "Magic Imbue",
				"Combine runes without a talisman", TDA, 23, 0, 5);
		addLunar3RunesBigBox(30210, 7956, 561, 557, 2, 1, 14, 30010, 30006, 82, "Fertile Soil",
				"Fertilise a farming patch with super\\ncompost", TDA, 24, 4, 2);
		addLunar3RunesBigBox(30218, 7956, 557, 555, 2, 11, 9, 30006, 30004, 83, "Boost Potion Share",
				"Shares a potion with up to 4 nearby\\nplayers", TDA, 25, 0, 5);
		addLunar3RunesSmallBox(30226, 7956, 563, 555, 2, 2, 9, 30012, 30004, 84, "Fishing Guild Teleport",
				"Teleports you to the fishing guild", TDA, 26, 0, 5);
		addLunar3RunesLargeBox(30234, 7956, 563, 555, 1, 2, 13, 30012, 30004, 85, "Tele Group Fishing\\nGuild",
				"Teleports players to the Fishing\\nGuild", TDA, 27, 0, 5);
		addLunar3RunesSmallBox(30242, 7956, 557, 561, 2, 14, 0, 30006, 30010, 85, "Plank Make", "Turn Logs into planks",
				TDA, 28, 16, 5);
		/******** Cut Off Limit **********/
		addLunar3RunesSmallBox(30250, 7956, 563, 555, 2, 2, 9, 30012, 30004, 86, "Catherby Teleport",
				"Teleports you to Catherby", TDA, 29, 0, 5);
		addLunar3RunesSmallBox(30258, 7956, 563, 555, 2, 2, 14, 30012, 30004, 87, "Tele Group Catherby",
				"Teleports players to Catherby", TDA, 30, 0, 5);
		addLunar3RunesSmallBox(30266, 7956, 563, 555, 2, 2, 7, 30012, 30004, 88, "Ice Plateau Teleport",
				"Teleports you to Ice Plateau", TDA, 31, 0, 5);
		addLunar3RunesBigBox(30274, 7956, 563, 555, 2, 2, 15, 30012, 30004, 89, "Tele Group Ice\\n Plateau",
				"Teleports players to Ice Plateau", TDA, 32, 0, 5);
		addLunar3RunesBigBox(30282, 7956, 563, 561, 2, 1, 0, 30012, 30010, 90, "Energy Transfer",
				"Spend hitpoints and SA Energy to\\n give another player hitpoints and run energy", TDA, 33, 8, 2);
		addLunar3RunesBigBox(30290, 7956, 563, 565, 2, 2, 0, 30012, 30014, 91, "Heal Other",
				"Transfer up to 75% of hitpoints\\n to another player", TDA, 34, 8, 2);
		addLunar3RunesBigBox(30298, 7956, 560, 557, 2, 1, 9, 30009, 30006, 92, "Vengeance Other",
				"Allows another player to rebound\\ndamage to an opponent", TDA, 35, 8, 2);
		addLunar3RunesSmallBox(30306, 7956, 560, 557, 3, 1, 9, 30009, 30006, 93, "Vengeance",
				"Rebound damage to an opponent", TDA, 36, 0, 5);
		addLunar3RunesBigBox(30314, 7956, 565, 563, 3, 2, 5, 30014, 30012, 94, "Heal Group",
				"Transfer up to 75% of hitpoints to a group", TDA, 37, 0, 5);
		addLunar3RunesBigBox(30322, 7956, 564, 563, 2, 1, 0, 30013, 30012, 95, "Spellbook Swap",
				"Change to another spellbook for 1\\nspell cast", TDA, 38, 0, 5);

		RSInterface Interface = addTabInterface(29999);
		setChildren(80, Interface);
		setBounds(11001, 11, 10, 0, Interface);
		...
		setBounds(11002, 6, 184, 40, Interface);// hover
	...
	public static void minigameTeleports(TextDrawingArea[] tda) {
		...
		addButtonWSpriteLoader(60682, 1018, "");
	...
	public static void newStarter(TextDrawingArea[] tda) {
		...
		addSpriteLoader(52751, 961);
		addText(52752, "StreamScape's Account Setup", 0xff9933, true, true, 52, tda, 3);
		...
		addConfigButtonWSpriteLoader(52758, 51750, 937, 938, 15, 15, "Select Hardcore", 2, 5, 1085);
		...
		addText(52763, "  Hardcore", 0xff9933, false, true, 52, tda, 0);
		addText(52764, "Play StreamScape as an Iron man.", 0xff9933, true, true, 52, tda, 0);
		...
		addHoverButtonWSpriteLoader(52769, 962, 123, 30, "Confirm selection", -1, 52770, 1);
		addHoveredImageWSpriteLoader(52770, 963, 123, 30, 52771);
		...
		tab.child(18, 52769, 364, 181);
		tab.child(19, 52770, 364, 181);
	...
	public static void note(TextDrawingArea[] tda) {
		...
		addText(17801, "", tda, 0, 0xFF0000, false, true);
		addText(17812, "", tda, 0, 0xFF0000, false, true);
		addText(17813, "", tda, 0, 0xFF0000, false, true);
		addText(17814, "", tda, 0, 0xFF0000, false, true);
		tab.totalChildren(7);
	...
	public static void optionsInterface() {
		String[] options = new String[] { /* "525 Frame" */ "N/A", "Old Hits", "Constitution" };
	...
	private static void playerPanel(TextDrawingArea[] tda) {
		RSInterface tab = addTabInterface(6939);
		RSInterface scroll = addTabInterface(15016);
		addText(39155, "Player Panel", tda, 1, 0xFF0000, true, true);
		...
		scroll.width = 174;
		scroll.height = 221;
		scroll.scrollMax = 753;
		tab.totalChildren(5);
		tab.child(0, 39155, 95, 4);
		...
		for (int i = 39159; i < 39214; i++) {
			...
			y += 16;
			k++;
			if (i == 39160 || i == 39171 || i == 39197 || i == 39198 || i == 39199 || i == 39200 || i == 39201
					|| i == 39202 || i == 39203 || i == 39204 || i == 39205 || i == 39189 || i == 39188) {
				addClickableText(i, "", "View", fonts, 1, 0xff7000, 167, 13);
			} else if (i == 39170) {
				addClickableText(i, "", "Toggle", fonts, 1, 0xff7000, 167, 13);
			} else if (i == 39162) {
				addClickableText(i, "", "Check", fonts, 1, 0xff7000, 167, 13);
			} else {
				addText(i, "", fonts, 1, 0xff7000, false, true);
			}
		}
	}
	...
	public static void playersOnline(TextDrawingArea[] tda) {
		/*
		 * RSInterface tab = addInterface(57000); addSpriteLoader(57001, 805);
		 * addText(57002, "Players Online", 0xff9933, true, true, -1, tda, 2);
		 * addText(57003, "", 0xff9933, true, true, -1, tda, 1); addText(57007,
		 * "StreamScape", 0xff9933, true, true, -1, tda, 0); addText(57008, "", 0xff9933,
		 * true, true, -1, tda, 3); addText(57009, "", 0xff9933, false, true, -1, tda,
		 * 0); addText(57010, "", 0xff9933, false, true, -1, tda, 0); addText(57011, "",
		 * 0xff9933, false, true, -1, tda, 0); addText(57012, "", 0xff9933, false, true,
		 * -1, tda, 0); addText(57013, "", 0xff9933, false, true, -1, tda, 0);
		 * addText(57014, "", 0xff9933, false, true, -1, tda, 0); addText(57015, "",
		 * 0xff9933, false, true, -1, tda, 0); addText(57016, "", 0xff9933, false, true,
		 * -1, tda, 0); addText(57017, "", 0xff9933, false, true, -1, tda, 0);
		 * addText(57018, "", 0xff9933, false, true, -1, tda, 0); addText(57019, "",
		 * 0xff9933, false, true, -1, tda, 0); addText(57020, "", 0xff9933, false, true,
		 * -1, tda, 0); addText(57021, "", 0xff9933, false, true, -1, tda, 0);
		 * addText(57022, "", 0xff9933, false, true, -1, tda, 0); addText(57023, "",
		 * 0xff9933, false, true, -1, tda, 0); addText(57024, "", 0xff9933, false, true,
		 * -1, tda, 0); addCloseButton(57004, 57005, 57006);
		 ...
		 * addHoveredImageWSpriteLoader(57029, 807, 73, 35, 57030); addText(57031,
		 * "Add", 0xff9933, true, true, -1, tda, 0); addText(57032, "Ignore", 0xff9933,
		 * true, true, -1, tda, 0); tab.totalChildren(30); tab.child(0, 57001, 14, 5);
		 * tab.child(1, 57040, 176, 90); tab.child(2, 57002, 175, 18); tab.child(3,
		 * 57003, 415, 58); tab.child(4, 57004, 470, 16); tab.child(5, 57005, 470, 16);
		 * tab.child(6, 57007, 415, 20); tab.child(7, 57008, 175, 65); tab.child(8,
		 * 57009, 60, 110); tab.child(9, 57010, 60, 125); tab.child(10, 57011, 60, 140);
		 * tab.child(11, 57012, 60, 155); tab.child(12, 57013, 60, 170); tab.child(13,
		 * 57014, 60, 185); tab.child(14, 57015, 60, 200); tab.child(15, 57016, 60,
		 * 215); tab.child(16, 57017, 187, 110); tab.child(17, 57018, 187, 125);
		 * tab.child(18, 57019, 187, 140); tab.child(19, 57020, 187, 155); tab.child(20,
		 * 57021, 187, 170); tab.child(21, 57022, 187, 185); tab.child(22, 57023, 187,
		 * 200); tab.child(23, 57024, 187, 215); tab.child(24, 57025, 80, 262);
		 * tab.child(25, 57026, 80, 262); tab.child(26, 57028, 202, 262); tab.child(27,
		 * 57029, 202, 262); tab.child(28, 57031, 114, 272); tab.child(29, 57032, 238,
		 * 272);
		 */

		RSInterface scrollInterface = addTabInterface(57040);
		scrollInterface.width = 300;
		scrollInterface.height = 211;
		scrollInterface.scrollMax = 5000;

		setChildren(300, scrollInterface);
		...
		int y = -15;
		for (int i = 0; i < 100; i++) {
			addText(57041 + i, i + "", fonts, 0, 0xD21C1C, false, true);
			setBounds(57041 + i, 185, y, i, scrollInterface);

			addConfigButtonWSpriteLoader(id, 60000, 1247, 1246, 120, 17, "Select Player", i, 5, 1110, id + hover, 128);
			setBounds(id, 180, y, frame, scrollInterface);
			frame++;
			addHoveredImageWSpriteLoaderTrans(id + hover, 1246, 120, 17, id + hover + 1, 96);
			setBounds(id + hover, 180, y, frame, scrollInterface);
			frame++;
			id++;
	...
	public static void prayerTab(TextDrawingArea[] tda) {
		...
		int k = 1;
		byte byte9 = 52;
		addText(687, "", 0xFF0000, false, true, -1, tda, 1);
	...
	private static void prayerTabInterface() {
		...
		int sixthRowXPos = 1;
		int sixthRowYPos = 52;
		addText(687, "", 0xFF0000, false, true, -1, fonts, 1);
	...
	private static void questTab(TextDrawingArea[] tda) {
		RSInterface tab = addTabInterface(6387);
		RSInterface scroll = addTabInterface(39239);
		addText(39243, "Quest Journal", tda, 1, 0xFF0000, true, true);
		addSpriteLoader(39244, 722);
		addSpriteLoader(39245, 723);
		addSpriteLoader(39246, 722);
		scroll.totalChildren(55);
		scroll.width = 174;
		scroll.height = 224;
		scroll.scrollMax = 120;
		tab.totalChildren(5);
		tab.child(0, 39243, 95, 4);
		tab.child(1, 39244, 0, 22);
		tab.child(2, 39245, 0, 25);
		tab.child(3, 39246, 0, 249);
		tab.child(4, 39239, 0, 25);
		int k = 0;
		int y = 0;
		for (int i = 39249; i < 39304; i++) {
			scroll.child(k, i, 6, y);
			y += 16;
			k++;
			if (i >= 39249 && i <= 39304) {
				addHoverText(i, "", "View", fonts, 1, 0xff0000, false, true, 167, 15);
			} else {
				addText(i, "", fonts, 1, 0xff0000, false, true);
			}
		}
	...
	private static void quickCursesInterface() {
		...
		addText(17235, "Select your quick curses:", fonts, 0, 0xFF0000, false, true);
		int i = 17202;
	...
	private static void quickPrayersInterface() {
		...
		addText(17230, "Select your quick prayers:", fonts, 0, 0xFF0000, false, true);
	...
	public static void Shop(TextDrawingArea[] TDA) {
		...
		addText(19679, "", 0xFF0000, false, true, 52, TDA, 1);
		...
		addText(19685, "Store Info", 0xFF0000, false, true, 52, TDA, 1);
	...
	public static void Sidebar0(TextDrawingArea[] tda) {
		...
		addToggleButton(150, 312, 172, 150, 44, "Auto Retaliate <col=880000>");
		...
		addText(19000, "Combat level:", tda, 0, 0xFF0000, true, false);
		addText(19001, "lolquoi", tda, 0, 0xFF0000, true, false);
		addText(32001, "", tda, 0, 0xFF0000, true, false);
		addText(32002, "", tda, 0, 0xFF0000, true, false);
		addText(32003, "", tda, 0, 0xFF0000, true, false);
		addText(32004, "", tda, 0, 0xFF0000, true, false);
		addText(32005, "", tda, 0, 0xFF0000, true, false);
		addText(32006, "", tda, 0, 0xFF0000, true, false);
		addText(33001, "", tda, 0, 0xFF0000, true, false);
		addText(33002, "", tda, 0, 0xFF0000, true, false);
		addText(33003, "", tda, 0, 0xFF0000, true, false);
		addText(33004, "", tda, 0, 0xFF0000, true, false);
		addText(33005, "", tda, 0, 0xFF0000, true, false);
		addText(33006, "", tda, 0, 0xFF0000, true, false);
		addText(33101, "", tda, 0, 0xFF0000, true, false);
		addText(33102, "", tda, 0, 0xFF0000, true, false);
		addText(33103, "", tda, 0, 0xFF0000, true, false);
		addText(33104, "", tda, 0, 0xFF0000, true, false);
		addText(33105, "", tda, 0, 0xFF0000, true, false);
		addText(33106, "", tda, 0, 0xFF0000, true, false);
	}
	...
	// spec
	{
		...
		addText(id2, "-2", tda, 3, 0xFF0000, true); // 2426
		addText(id2 + 11, text1, tda, 0, 0xFF0000, false);
		addText(id2 + 12, text2, tda, 0, 0xFF0000, false);
		addText(id2 + 13, text3, tda, 0, 0xFF0000, false);
		addText(id2 + 14, text4, tda, 0, 0xFF0000, false);
		/* specialBar(ID); */
	...
	// spec
	{
		...
		/* addText(ID, "Text", tda, Size, Colour, Centered); */
		addText(id2, "-2", tda, 3, 0xFF0000, true); // 2426
		addText(id2 + 9, text1, tda, 0, 0xFF0000, false);
		addText(id2 + 10, text2, tda, 0, 0xFF0000, false);
		addText(id2 + 11, text3, tda, 0, 0xFF0000, false);
		/* specialBar(ID); */
		rsi.specialBar(id3); // 7599
	...
	// (magic intf)
	{
		...
		// addText(353, "Spell", tda, 0, 0xFF0000, false);
		removeSomething(353);
		addText(354, "Spell", tda, 0, 0xFF0000, false);
	...
	private static void skillTabInterface() {
		...
		addSpriteLoaderButtonWithTooltipBox(31110, 31111, 245, "View @or2@Attack @lre@Options", 268, 31112,
				"Attack: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31114, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31115, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31112].contentType = 1004;

		addSpriteLoaderButtonWithTooltipBox(31110, 31116, 265, "View @or2@Strength @lre@Options", 268, 31117,
				"Strength: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31119, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31120, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31117].contentType = 1007;

		addSpriteLoaderButtonWithTooltipBox(31110, 31121, 249, "View @or2@Defence @lre@Options", 268, 31122,
				"Defence: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31124, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31125, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31122].contentType = 1010;

		addSpriteLoaderButtonWithTooltipBox(31110, 31126, 261, "View @or2@Ranged @lre@Options", 268, 31127,
				"Ranged: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31129, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31130, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31127].contentType = 1013;

		addSpriteLoaderButtonWithTooltipBox(31110, 31131, 260, "View @or2@Prayer @lre@Options", 268, 31132,
				"Prayer: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31134, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31135, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31132].contentType = 1016;

		addSpriteLoaderButtonWithTooltipBox(31110, 31136, 258, "View @or2@Magic @lre@Options", 268, 31137,
				"Magic: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31139, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31140, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31137].contentType = 1019;

		addSpriteLoaderButtonWithTooltipBox(31110, 31141, 262, "View @or2@Runecrafting @lre@Options", 268, 31142,
				"Runecrafting: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31144, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31145, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31142].contentType = 1022;

		addSpriteLoaderButtonWithTooltipBox(31110, 31146, 246, "View @or2@Construction @lre@Options", 268, 31147,
				"Construction: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31149, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31150, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31147].contentType = 1025;

		addSpriteLoaderButtonWithTooltipBox(31110, 31151, 250, "View @or2@Dungeoneering @lre@Options", 268, 31152,
				"Dungeoneering: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 60, 0);
		addText(31154, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31155, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31152].contentType = 1028;

		addSpriteLoaderButtonWithTooltipBox(31110, 31156, 256, "View @or2@Constitution @lre@Options", 268, 31157,
				"Constitution: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31159, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31160, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31157].contentType = 1005;

		addSpriteLoaderButtonWithTooltipBox(31110, 31161, 244, "View @or2@Agility @lre@Options", 268, 31162,
				"Agility: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31164, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31165, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31162].contentType = 1008;

		addSpriteLoaderButtonWithTooltipBox(31110, 31166, 255, "View @or2@Herblore @lre@Options", 268, 31167,
				"Herblore: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31169, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31170, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31167].contentType = 1011;

		addSpriteLoaderButtonWithTooltipBox(31110, 31171, 267, "View @or2@Thieving @lre@Options", 268, 31172,
				"Thieving: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31174, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31175, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31172].contentType = 1014;

		addSpriteLoaderButtonWithTooltipBox(31110, 31176, 248, "View @or2@Crafting @lre@Options", 268, 31177,
				"Crafting: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31179, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31180, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31177].contentType = 1017;

		addSpriteLoaderButtonWithTooltipBox(31110, 31181, 254, "View @or2@Fletching @lre@Options", 268, 31182,
				"Fletching: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31184, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31185, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31182].contentType = 1020;

		addSpriteLoaderButtonWithTooltipBox(31110, 31186, 263, "View @or2@Slayer @lre@Options", 268, 31187,
				"Slayer: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31189, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31190, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31187].contentType = 1023;

		addSpriteLoaderButtonWithTooltipBox(31110, 31191, 257, "View @or2@Hunter @lre@Options", 268, 31192,
				"Hunter: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31194, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31195, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31192].contentType = 1026;

		addSpriteLoaderButtonWithTooltipBox(31110, 31196, 269, "Total Level", 270, 31197,
				"Total Level: 1024\nTotal XP: 99999999", 0, 0);
		addText(31199, "Total Level:", 0xFF0000, false, true, 52, fonts, 0);
		addText(31200, "2475", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31197].contentType = 1029;

		addSpriteLoaderButtonWithTooltipBox(31110, 31201, 259, "View @or2@Mining @lre@Options", 268, 31202,
				"Mining: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31204, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31205, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31202].contentType = 1006;

		addSpriteLoaderButtonWithTooltipBox(31110, 31206, 264, "View @or2@Smithing @lre@Options", 268, 31207,
				"Smithing: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31209, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31210, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31207].contentType = 1009;

		addSpriteLoaderButtonWithTooltipBox(31110, 31211, 253, "View @or2@Fishing @lre@Options", 268, 31212,
				"Fishing: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31214, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31215, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31212].contentType = 1012;

		addSpriteLoaderButtonWithTooltipBox(31110, 31216, 247, "View @or2@Cooking @lre@Options", 268, 31217,
				"Cooking: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31219, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31220, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31217].contentType = 1015;

		addSpriteLoaderButtonWithTooltipBox(31110, 31221, 252, "View @or2@Firemaking @lre@Options", 268, 31222,
				"Firemaking: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31224, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31225, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31222].contentType = 1018;

		addSpriteLoaderButtonWithTooltipBox(31110, 31226, 243, "View @or2@Woodcutting @lre@Options", 268, 31227,
				"Woodcutting: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31229, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31230, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31227].contentType = 1021;

		addSpriteLoaderButtonWithTooltipBox(31110, 31231, 251, "View @or2@Farming @lre@Options", 268, 31232,
				"Farming: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31234, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31235, "99", 0xFF0000, false, true, 52, fonts, 0);
		RSInterface.interfaceCache[31232].contentType = 1024;

		addSpriteLoaderButtonWithTooltipBox(31110, 31236, 266, "View @or2@Summoning @lre@Options", 268, 31237,
				"Summoning: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		addText(31239, "99", 0xFF0000, false, true, 52, fonts, 0);
		addText(31240, "99", 0xFF0000, false, true, 52, fonts, 0);
	...
	public static void skillTabInterface2() {
		...
		for (int i = 0; i < hovers.length; i++) {
			...
			// interfaceCache[buttons[i]].parentID = 3917;
			interfaceCache[hovers[i]].parentID = 3917;
	...
	public static void staffTabInterface(TextDrawingArea[] tda) {
		...
		addText(32386, "Staff Panel", fonts, 1, 0xFF0000, true, true);
		addText(32394, "Click a staff members name to", fonts, 0, 0xFF0000, true, true);
		addText(32395, "request help.", fonts, 0, 0xFF0000, true, true);
		addText(32396, "Online Staff: 1", fonts, 2, 0xFF0000, true, true);
	 ...
	 * Summoning tab
	 */
	public static void summoningTabInterface(TextDrawingArea[] tda) {
		RSInterface rsi = addTabInterface(54017);
		addText(54019, "Summoning Familiar", tda, 1, 0xFF0000, true, true);
		addSpriteLoader(54020, 874);

		addFamiliarHead(54021, 75, 50, 875);
		addSpriteLoader(54027, 875);
		addText(54028, "", fonts, 2, 0xFF0000, true, false);
	...
	public static void Trade(TextDrawingArea[] TDA) {
		...
		addText(3417, "Trading With:", 0xFF0000, true, true, 52, TDA, 2);
		addText(3418, "Trader's Offer", 0xFF0000, false, true, 52, TDA, 1);
		addText(3419, "Your Offer", 0xFF0000, false, true, 52, TDA, 1);
		...
		addText(53505, "1 has\\n 28 free\\n inventory slots.", 0xFF0000, true, true, -1, TDA, 0);
	...
	private static void tradeInterface() {
		...
		addText(3417, "Trading With:", 0xFF0000, true, true, 52, fonts, 2);
		addText(3418, "Trader's Offer", 0xFF0000, false, true, 52, fonts, 1);
		addText(3419, "Your Offer", 0xFF0000, false, true, 52, fonts, 1);
		...
		addText(12504, "Wealth transfer: 2147,000,000 coins' worth to Zezimablud12", 0xB9B855, true, true, -1, fonts,
				0);
		addText(12505, "1 has\\n 28 free\\n inventory slots.", 0xFF0000, true, true, -1, fonts, 0);
		...
		addText(3452, "Loan:", 0xFF0000, false, true, 52, fonts, 1);
		addText(3453, "Loan:", 0xFF0000, false, true, 52, fonts, 1);
		String[] options = { "Remove" };
		addItemOnInterface(3454, 3323, options);
		addItemOnInterface(3455, 3324, options);
		addText(3456, "Hours:", 0xFF0000, false, true, 52, fonts, 1);
		addText(3457, "Hours:", 0xFF0000, false, true, 52, fonts, 1);
		/*
		...
		// THE TRADE BUTTON IMAGES ARE NOT USED! I didn't like them. The
		// interface looks better without them.
	...
	public static void trainingTeleports(TextDrawingArea[] tda) {
		...
		addSpriteLoader(60601, 1024);

		addHoverSpriteLoaderButton(60602, 1025, 120, 26, "Select", 0, 60603, 1);
		addHoveredSpriteLoaderButton(60603, 120, 26, 60604, 1026);

		addHoverSpriteLoaderButton(60605, 1025, 120, 26, "Select", 0, 60606, 1);
		addHoveredSpriteLoaderButton(60606, 120, 26, 60607, 1026);

		addHoverSpriteLoaderButton(60608, 1025, 120, 26, "Select", 0, 60609, 1);
		addHoveredSpriteLoaderButton(60609, 120, 26, 60610, 1026);

		addHoverSpriteLoaderButton(60611, 1025, 120, 26, "Select", 0, 60612, 1);
		addHoveredSpriteLoaderButton(60612, 120, 26, 60613, 1026);

		addHoverSpriteLoaderButton(60614, 1025, 120, 26, "Select", 0, 60615, 1);
		addHoveredSpriteLoaderButton(60615, 120, 26, 60616, 1026);

		addHoverSpriteLoaderButton(60617, 1025, 120, 26, "Select", 0, 60618, 1);
		addHoveredSpriteLoaderButton(60618, 120, 26, 60619, 1026);

		// More buttons
		addHoverSpriteLoaderButton(60691, 1025, 120, 26, "Select", 0, 60692, 1);
		addHoveredSpriteLoaderButton(60692, 120, 26, 60693, 1026);

		addHoverSpriteLoaderButton(60649, 1025, 120, 26, "Select", 0, 60650, 1);
		addHoveredSpriteLoaderButton(60650, 120, 26, 60651, 1026);

		addHoverSpriteLoaderButton(60694, 1025, 120, 26, "Select", 0, 60695, 1);
		addHoveredSpriteLoaderButton(60695, 120, 26, 60696, 1026);

		addHoverSpriteLoaderButton(60622, 1027, 90, 32, "Teleport", 0, 60623, 1);
		addHoveredSpriteLoaderButton(60623, 90, 32, 60624, 1028);

		addHoverSpriteLoaderButton(60625, 1027, 90, 32, "Teleport", 0, 60626, 1);
		addHoveredSpriteLoaderButton(60626, 90, 32, 60627, 1028);

		addHoverSpriteLoaderButton(60628, 1027, 90, 32, "Teleport", 0, 60629, 1);
		addHoveredSpriteLoaderButton(60629, 90, 32, 60630, 1028);

		addHoverSpriteLoaderButton(60631, 1027, 90, 32, "Teleport", 0, 60632, 1);
		addHoveredSpriteLoaderButton(60632, 90, 32, 60633, 1028);

		addHoverSpriteLoaderButton(60634, 1027, 90, 32, "Teleport", 0, 60635, 1);
		addHoveredSpriteLoaderButton(60635, 90, 32, 60636, 1028);

		addHoverSpriteLoaderButton(60637, 1027, 90, 32, "Teleport", 0, 60638, 1);
		addHoveredSpriteLoaderButton(60638, 90, 32, 60639, 1028);

		addHoverSpriteLoaderButton(60640, 1027, 90, 32, "Teleport", 0, 60641, 1);
		addHoveredSpriteLoaderButton(60641, 90, 32, 60642, 1028);

		addHoverSpriteLoaderButton(60643, 1027, 90, 32, "Teleport", 0, 60644, 1);
		addHoveredSpriteLoaderButton(60644, 90, 32, 60645, 1028);

		addHoverSpriteLoaderButton(60646, 1027, 90, 32, "Teleport", 0, 60647, 1);
		addHoveredSpriteLoaderButton(60647, 90, 32, 60648, 1028);
		addHoverSpriteLoaderButton(60652, 65, 16, 16, "Close", 0, 60653, 1);
		addHoveredSpriteLoaderButton(60653, 16, 16, 60654, 66);
		addButtonWSpriteLoader(60655, 1023, "");
		addText(60656, "Mob Zones (1)", tda, 1, 0xFF9900, true, true);
		addText(60657, "Mob Zones (2)", tda, 1, 0xFF9900, true, true);
		addText(60658, "Mini-games (1)", tda, 1, 0xFF9900, true, true);
		addText(60659, "Mini-games (2)", tda, 1, 0xFF9900, true, true);
		addText(60660, "Bosses (1)", tda, 1, 0xFF9900, true, true);
		addText(60661, "Bosses (2)", tda, 1, 0xFF9900, true, true);
		addText(60697, "Dungeons", tda, 1, 0xFF9900, true, true);
		addText(60698, "PvP Zones", tda, 1, 0xFF9900, true, true);
		addText(60699, "Donor Zones", tda, 1, 0xFF9900, true, true);
		addText(60662, "", tda, 1, 0xFF9900, true, true);
		addText(60663, "", tda, 1, 0xFF9900, true, true);
		addText(60664, "", tda, 1, 0xFF9900, true, true);
		addText(60665, "", tda, 1, 0xFF0000, true, true);
		addText(60666, "", tda, 1, 0xFF0000, true, true);
		addText(60667, "", tda, 1, 0xFF0000, true, true);
		addText(60668, "", tda, 1, 0xFF0000, true, true);
		addText(60669, "", tda, 1, 0xFF0000, true, true);
		addText(60670, "", tda, 1, 0xFF0000, true, true);
		addText(60671, "", tda, 1, 0xFF0000, true, true);
		addText(60672, "", tda, 1, 0xFF0000, true, true);
		addText(60673, "", tda, 1, 0xFF0000, true, true);
		addText(60674, "", tda, 1, 0xFF0000, true, true);
		addText(60675, "", tda, 1, 0xFF0000, true, true);
		addText(60676, "", tda, 1, 0xFF0000, true, true);
		addText(60677, "", tda, 1, 0xFF0000, true, true);
		addText(60678, "", tda, 1, 0xFF0000, true, true);
		addText(60679, "", tda, 1, 0xFF0000, true, true);
		addText(60690, "Teleporting - Select your destination", tda, 2, 0xFF0000, true, true);
		...
		rsInterface.child(29, 60646, 383, 232); // Button 9 Hover
		rsInterface.child(30, 60647, 383, 232); // Button 9
		rsInterface.child(31, 60649, 14, 225); // Button 10 Hover
		rsInterface.child(32, 60650, 14, 225); // Button 10
		rsInterface.child(33, 60652, 480, 17); // Close Hover
		rsInterface.child(34, 60653, 480, 17); // Close
		...
		// rsInterface.child(69, 60681, 82, 247); // Teleport Text 10
		rsInterface.child(68, 60690, 258, 18); // Title
		rsInterface.child(69, 60691, 14, 199); // Tab 5 Hover
		rsInterface.child(70, 60692, 14, 199); // Tab 5
		rsInterface.child(71, 60694, 14, 251); // Tab 5 Hover
		rsInterface.child(72, 60695, 14, 251); // Tab 5
		rsInterface.child(73, 60697, 75, 203); // Title 7
		rsInterface.child(74, 60698, 75, 229); // Title 8
		rsInterface.child(75, 60699, 75, 255); // Title 9
	}
	...
	public static void unpack(CacheArchive streamLoader, TextDrawingArea textDrawingAreas[],
		...
		while (stream.currentOffset < stream.buffer.length) {
			...
			if (rsInterface.type == 4) {
				rsInterface.message = stream.readString().replaceAll("RuneScape", "StreamScape");
				if (rsInterface.message.toLowerCase().equals("the bank of StreamScape")) {
					rsInterface.message = "    @gre@The Bank of StreamScape";
				}
		...
		combinationKeys(textDrawingAreas);
		...
		shopInterface();
		theBankOfStreamScape(textDrawingAreas);
		StreamScapeGameSettings(textDrawingAreas);
		prayerTabInterface();
		quickPrayersInterface();
		curseTabInterface();
		quickCursesInterface();
		summoningBoBInterface();
		summoningTabInterface(textDrawingAreas);
		priceCheckerInterface();
		achievementsInterface(textDrawingAreas);
		dropp(textDrawingAreas);
		yellEditor();
		loyaltyShop();
		wildernessInterface();
		...
		gambleBlackJack(textDrawingAreas);
		spriteCache = null;
	}

	public static void questInformation(TextDrawingArea[] tda) {
		int interfaceID = 8134;
		int[] freeInterfaceIDs = new int[] { 15269, 15271, 15276, 15277, 15278, 15279 };

		removeSomething(interfaceID + 2);
		removeSomething(interfaceID + 10);
		// Background
		interfaceCache[interfaceID].childX[0] = 95;
		interfaceCache[interfaceID].childY[0] = 106;

		interfaceCache[interfaceID + 12].mediaID = 40721;
		interfaceCache[interfaceID + 12].modelRotation1 = 0;
		interfaceCache[interfaceID + 12].modelRotation2 = 0;
		interfaceCache[interfaceID + 12].modelZoom = 665;
		interfaceCache[interfaceID + 12].width = 0;
		interfaceCache[interfaceID + 12].height = 0;

		// Top Banner
		addMediaModel(freeInterfaceIDs[0], 40720, 460, 42);
		interfaceCache[freeInterfaceIDs[0]].modelZoom = 720;
		insertNewChild(interfaceCache[interfaceID], freeInterfaceIDs[0], 28, 0);

		// Top middle
		addMediaModel(freeInterfaceIDs[1], 40722, 460, 42);
		interfaceCache[freeInterfaceIDs[1]].modelZoom = 666;
		insertNewChild(interfaceCache[interfaceID], freeInterfaceIDs[1], 28, 54);

		// Bottom middle
		addMediaModel(freeInterfaceIDs[2], 40722, 460, 42);
		interfaceCache[freeInterfaceIDs[2]].modelRotation1 = 1024;
		interfaceCache[freeInterfaceIDs[2]].modelRotation2 = 1024;
		interfaceCache[freeInterfaceIDs[2]].modelZoom = 666;
		insertNewChild(interfaceCache[interfaceID], freeInterfaceIDs[2], 28, 287);

		insertNewChild(interfaceCache[interfaceID], freeInterfaceIDs[3], 450, 60);
		insertNewChild(interfaceCache[interfaceID], freeInterfaceIDs[4], 450, 60);

		addHoverButtonWSpriteLoader(freeInterfaceIDs[3], 959, 23, 23, "Close", 250, freeInterfaceIDs[4], 3);
		addHoveredImageWSpriteLoader(freeInterfaceIDs[4], 960, 23, 23, freeInterfaceIDs[5]);

		// interfaceCache[interfaceID + 9].width = 376;
		// interfaceCache[interfaceID + 9].height = 216;
		interfaceCache[interfaceID].childY[2] = 84;
		interfaceCache[interfaceID].childX[2] = 76;

		removeSomething(8144);
		addText(637, "", tda, 3, 0xff0000, true, true);
		insertNewChild(interfaceCache[interfaceID], 637, 250, 16);
	}
	...
	private static void walkableTextInterface() {
		...
		addText(37308, "Killcount: 2", fonts, 2, 0xFF0000, true, true);
		tab.totalChildren(1);
	...
	private Model getMediaModel(int drawType, int mediaId) {
		...
		if (drawType == DRAW_PLAYER_MODEL)
			model = GameClient.myPlayer.getPlayerModel();
	...
	private static final int ORANGE_TEXT = 0xFF0000;
	...
	public static final MemCache modelCache = new MemCache(30);

	public static int summoningItemRequirements[][] = { { 12158, 2859, -1 }, // Wolf
			// pouch
