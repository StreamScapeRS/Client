...
public class Configuration {
	...
	public final static String CLIENT_NAME = "StreamScape";
	public final static double CLIENT_VERSION = 1.0;

	public final static String HOST = "162.252.11.173"; // "162.252.11.173";
	public final static int PORT = 43594; // dev 13376 /13377
	public final static String JAGGRAB_HOST = "162.252.11.173"; // "162.252.11.173";

	/**
	 * The NPC bits. 12 = 317/377s 14 = 474+ 16 = 600+
	 */
	public final static int NPC_BITS = 18;

	/*
	 * Update-server enabled? Redone by StreamScape
	 */
	public static final int JAGGRAB_PORT = 55555;
	public static final int FILE_SERVER_PORT = 55555;
	public static boolean JAGCACHED_ENABLED = false; // File Server
	...
	public static final String VERSION_URL = "http://www.Streamscape.ca";
}
