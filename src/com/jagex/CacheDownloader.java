...
public class CacheDownloader {
	private static final String CACHE_NAME = "Streamscapecache.zip";
	private static final String CACHE_URL = "https://dl.dropbox.com/s/e8yfezik5qzstd4/Streamscapecache.zip" + CACHE_NAME;
	private static final String VERSION_URL = "http://Streamscape.ca";
	...
	private static void download() throws Exception {
		...
		if (responseCode == HttpURLConnection.HTTP_OK) {
			...
			while ((bytesRead = inputStream.read(buffer)) != -1) {
				...
				GameClient.instance.setLoadingText(percentage,
